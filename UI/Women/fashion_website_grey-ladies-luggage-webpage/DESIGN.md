...
| Body | sans-serif | 16px | 600 | inherit | 0.5px |
| Caption | monospace, monospace | 16px | 800 | 0 | 6px |
| Button | SFMono-Regular, Menlo, Monaco, Consolas, Liberation Mono, Courier New, monospace | 16px | bolder | 2em | 3px |
| Mono | SFMono-Regular, Menlo, Monaco, Consolas, Liberation Mono, Courier New, monospace | 17px | bolder | 2em | 3px |
...
### Quick Prompt
> "Based on the `moban3596` design system, use the color palette and typography hierarchy above to generate a modern landing page with navigation, hero section, card grid, and form — output both light and dark themes."
