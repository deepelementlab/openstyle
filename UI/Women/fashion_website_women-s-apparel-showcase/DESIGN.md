...
- **Vivid Blue 2** (`rgba(0,123,255,.5)`): CTAs, links, and interactive highlights
### Neutral
...
| Sub-heading | Raleway, sans-serif | 16px | 300 | 1.8em | normal |
| Body | FontAwesome | 16px | 800 | inherit | 0.225em |
| Caption | sans-serif | 14px | 600 | 1.2 | 3px |
| Button | monospace, monospace | 16px | bolder | 1.75em | 0.22em |
| Mono | monospace, monospace | 16px | bolder | 1.75em | 0.22em |
| Label | monospace, monospace | 16px | bolder | 1.75em | 0.22em |
...
### Quick Prompt
> "Based on the `moban3485` design system, use the color palette and typography hierarchy above to generate a modern landing page with navigation, hero section, card grid, and form — output both light and dark themes."
