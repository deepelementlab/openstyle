# Design System: cpts 1934 dfj

## 1. Visual Theme & Atmosphere

This template presents a structured, modular web design built on a mid gray with white canvas, using Vivid Blue as the primary accent for interactive elements. The typography is anchored by `-apple-system`, creating a consistent reading experience. The type scale spans 14px to 40px across 8 levels.
...
- **Soft Vivid Red** (`#fc4242`): CTAs, links, and interactive highlights
### Neutral
...
| Heading | inherit | 20px | 700 | 1 | normal |
| Sub-heading | Nunito Sans, sans-serif | 14px | 300 | inherit | 4px |
| Body | Lato, sans-serif | 16px | 600 | 1.2 | 2px |
| Caption | sans-serif | 16px | bold | 0 | 3px |
| Button | monospace, monospace | 16px | 500 | 1.15 | 0.5px |
| Mono | monospace, monospace | 40px | 500 | 1.15 | 0.5px |
| Label | monospace, monospace | 16px | 500 | 1.15 | 0.5px |
...
### Quick Prompt
> "Based on the `cpts 1934 dfj` design system, use the color palette and typography hierarchy above to generate a modern landing page with navigation, hero section, card grid, and form — output both light and dark themes."
