# Design System: cpts 2010 egh

## 1. Visual Theme & Atmosphere

This template presents a structured, modular web design built on a mid gray with pale vivid yellow canvas, using Blue as the primary accent for interactive elements. The typography is anchored by `Poppins`, creating a consistent reading experience. The type scale spans 12px to 18px across 8 levels.
...
|------|------|------|--------|-------------|----------------|
| Display | Poppins, sans-serif | 12px | bold | 1.428571 | 27px |
| Heading | Helvetica Neue, Helvetica, Arial, sans-serif | 16px | normal | 1 | 3px |
| Sub-heading | inherit | 14px | 300 | 1.5 | 1px |
| Body | sans-serif | 18px | 600 | 0 | 1px |
| Caption | monospace, monospace | 16px | 500 | 1.333333 | 1px |
| Button | Glyphicons Halflings | 16px | 200 | 37px | 1px |
| Mono | Glyphicons Halflings | 16px | 200 | 37px | 1px |
| Label | Glyphicons Halflings | 16px | 200 | 37px | 1px |
...
### Quick Prompt
> "Based on the `cpts 2010 egh` design system, use the color palette and typography hierarchy above to generate a modern landing page with navigation, hero section, card grid, and form — output both light and dark themes."
