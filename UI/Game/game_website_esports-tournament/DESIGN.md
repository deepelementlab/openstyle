...
- **Dark Vivid Teal** (`#006B61`): CTAs, links, and interactive highlights
### Neutral
...
| Heading | Open Sans, sans-serif | 14px | 600 | 1 | 1px |
| Sub-heading | Raleway, sans-serif | 18px | 400 | 30px | 1px |
| Body | sans-serif | 20px | 300 | 46px | 1px |
| Caption | monospace, monospace | 16px | 500 | 1.5 | 1px |
| Button | Glyphicons Halflings | 16px | 200 | 1.33 | 1px |
| Mono | Glyphicons Halflings | 30px | 200 | 1.33 | 1px |
| Label | Glyphicons Halflings | 16px | 200 | 1.33 | 1px |
...
### Quick Prompt
> "Based on the `moban4367` design system, use the color palette and typography hierarchy above to generate a modern landing page with navigation, hero section, card grid, and form — output both light and dark themes."
