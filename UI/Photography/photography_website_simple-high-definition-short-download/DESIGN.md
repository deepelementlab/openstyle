# Design System: templatemo 552 video catalog
...
| Heading | Font Awesome 5 Free | 20px | 700 | 1 | normal |
| Sub-heading | SFMono-Regular, Menlo, Monaco, Consolas, Liberation Mono, Courier New, monospace | 16px | 300 | inherit | normal |
| Body | Font Awesome 5 Brands | 16px | 900 | 1.2 | normal |
| Caption | sans-serif | 24px | bolder | 2em | normal |
| Button | inherit | 16px | 500 | 0.75em | normal |
| Mono | inherit | 40px | 500 | 0.75em | normal |
| Label | inherit | 16px | 500 | 0.75em | normal |
...
### Quick Prompt
> "Based on the `templatemo 552 video catalog` design system, use the color palette and typography hierarchy above to generate a modern landing page with navigation, hero section, card grid, and form — output both light and dark themes."
