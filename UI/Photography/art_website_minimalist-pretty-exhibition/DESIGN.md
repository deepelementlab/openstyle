# Design System: tops 51 acidus

## 1. Visual Theme & Atmosphere

This template presents a structured, modular web design built on a black with pale vivid yellow canvas, using Blue as the primary accent for interactive elements. The typography is anchored by `Helvetica Neue`, creating a consistent reading experience. The type scale spans 12px to 21px across 8 levels.
...
- **Muted Blue** (`#515769`): CTAs, links, and interactive highlights
- **Vivid Cyan** (`#17bed2`): CTAs, links, and interactive highlights
### Neutral
...
| Heading | Simple-Line-Icons | 14px | 700 | 1 | 1px |
| Sub-heading | inherit | 18px | 600 | 1.5 | 1px |
| Body | sans-serif | 13px | 500 | 1.333333 | 1px |
| Caption | monospace, monospace | 16px | 300 | 30px | 1px |
| Button | Glyphicons Halflings | 16px | 200 | 46px | 1px |
| Mono | Glyphicons Halflings | 16px | 200 | 46px | 1px |
| Label | Glyphicons Halflings | 21px | 200 | 46px | 1px |
...
### Quick Prompt
> "Based on the `tops 51 acidus` design system, use the color palette and typography hierarchy above to generate a modern landing page with navigation, hero section, card grid, and form — output both light and dark themes."
