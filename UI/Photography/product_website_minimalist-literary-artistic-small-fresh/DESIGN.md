...
| Heading | inherit | 14px | 700 | 1 | 1px |
| Sub-heading | flexslider-icon | 18px | 300 | 1.5 | -1px |
| Body | sans-serif | 16px | 500 | 1.333333 | 4px |
| Caption | monospace, monospace | 16px | 200 | 30px | 2px |
| Button | Glyphicons Halflings | 16px | bold | 46px | 2px |
| Mono | Glyphicons Halflings | 21px | bold | 46px | 2px |
| Label | Glyphicons Halflings | 20px | bold | 46px | 2px |
...
### Quick Prompt
> "Based on the `dstp 4 adriya` design system, use the color palette and typography hierarchy above to generate a modern landing page with navigation, hero section, card grid, and form — output both light and dark themes."
