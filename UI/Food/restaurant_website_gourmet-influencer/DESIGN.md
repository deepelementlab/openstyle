...
| Sub-heading | sans-serif | 14px | bold | 1.5 | 0.4px |
| Body | monospace, monospace | 16px | 500 | 1.333333 | 1px |
| Caption | Glyphicons Halflings | 16px | 300 | 30px | 8px |
| Button | Menlo, Monaco, Consolas, Courier New, monospace | 16px | 200 | 46px | 8px |
| Mono | Menlo, Monaco, Consolas, Courier New, monospace | 16px | 200 | 46px | 8px |
| Label | Menlo, Monaco, Consolas, Courier New, monospace | 16px | 200 | 46px | 8px |
...
### Quick Prompt
> "Based on the `moban3099` design system, use the color palette and typography hierarchy above to generate a modern landing page with navigation, hero section, card grid, and form — output both light and dark themes."
