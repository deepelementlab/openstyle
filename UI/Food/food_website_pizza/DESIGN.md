# Design System: moban3128

## 1. Visual Theme & Atmosphere

This template presents a structured, modular web design built on a mid gray with white canvas, using Vivid Blue as the primary accent for interactive elements. The typography is anchored by `Montserrat`, creating a consistent reading experience. The type scale spans 14px to 24px across 8 levels.
...
- **Vivid Amber 2** (`#ffbf00`): CTAs, links, and interactive highlights
### Neutral
...
|------|------|------|--------|-------------|----------------|
| Display | Montserrat, sans-serif | 14px | 400 | 1.5 | 1px |
| Heading | Shadows Into Light, cursive | 20px | 600 | 1 | 2px |
| Sub-heading | -apple-system, BlinkMacSystemFont, Segoe UI, Roboto, Helvetica Neue, Arial, sans-serif, Apple Color Emoji, Segoe UI Emoji, Segoe UI Symbol | 14px | 300 | inherit | 3px |
| Body | Lobster, cursive | 16px | 700 | 1.2 | normal |
| Caption | inherit | 16px | 500 | 28px | 5px |
| Button | sans-serif | 16px | bold | 1.15 | 0 |
| Mono | sans-serif | 16px | bold | 1.15 | 0 |
| Label | sans-serif | 24px | bold | 1.15 | 0 |
...
### Quick Prompt
> "Based on the `moban3128` design system, use the color palette and typography hierarchy above to generate a modern landing page with navigation, hero section, card grid, and form — output both light and dark themes."
