# Design System: cpts 1478 chu

## 1. Visual Theme & Atmosphere

This template presents a structured, modular web design built on a black with pale vivid yellow canvas, using Vivid Cyan as the primary accent for interactive elements. The typography is anchored by `Roboto`, creating a consistent reading experience. The type scale spans 12px to 18px across 8 levels.
...
### Accent
- **Vivid Cyan** (`#02bbd2`): CTAs, links, and interactive highlights
...
|------|------|------|--------|-------------|----------------|
| Display | Roboto, sans-serif | 12px | normal | 1.428571 | 1px |
| Heading | Helvetica Neue, Helvetica, Arial, sans-serif | 16px | 300 | 1 | 3px |
| Sub-heading | inherit | 14px | bold | 1.5 | 2px |
| Body | Bigshot One, cursive | 18px | 400 | 0 | 5px |
| Caption | sans-serif | 16px | 500 | 1.333333 | 4px |
| Button | monospace, monospace | 16px | 200 | 30px | 4px |
| Mono | monospace, monospace | 16px | 200 | 30px | 4px |
| Label | monospace, monospace | 16px | 200 | 30px | 4px |
...
- Use `#02bbd2` as the primary accent for CTAs and interactive elements.
...
### Quick Prompt
> "Based on the `cpts 1478 chu` design system, use the color palette and typography hierarchy above to generate a modern landing page with navigation, hero section, card grid, and form — output both light and dark themes."

### Key Token Reference
- **Text:** Pale Vivid Yellow (`#fcf8e3`)
- **CTA / Accent:** Vivid Cyan (`#02bbd2`)
- **Border:** White (`#fff`)
