# Design System: templatemo 461 workforce
...
- **Soft Vivid Blue** (`#55acee`): CTAs, links, and interactive highlights
...
| Sub-heading | sans-serif | 18px | bold | 1.5 | 2px |
| Body | monospace, monospace | 16px | 300 | 1.333333 | 2px |
| Caption | Glyphicons Halflings | 16px | 500 | 30px | 2px |
| Button | Menlo, Monaco, Consolas, Courier New, monospace | 16px | 200 | 46px | 2px |
| Mono | Menlo, Monaco, Consolas, Courier New, monospace | 16px | 200 | 46px | 2px |
| Label | Menlo, Monaco, Consolas, Courier New, monospace | 21px | 200 | 46px | 2px |
...
### Quick Prompt
> "Based on the `templatemo 461 workforce` design system, use the color palette and typography hierarchy above to generate a modern landing page with navigation, hero section, card grid, and form — output both light and dark themes."
