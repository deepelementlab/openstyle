...
- **Vivid Amber** (`#ffa400`): CTAs, links, and interactive highlights
...
| Sub-heading | sans-serif | 18px | bold | 1.5 | 1px |
| Body | monospace, monospace | 16px | 500 | 1.333333 | 0.9px |
| Caption | Glyphicons Halflings | 16px | 300 | 30px | 0.9px |
| Button | Menlo, Monaco, Consolas, Courier New, monospace | 16px | 200 | 46px | 0.9px |
| Mono | Menlo, Monaco, Consolas, Courier New, monospace | 16px | 200 | 46px | 0.9px |
| Label | Menlo, Monaco, Consolas, Courier New, monospace | 16px | 200 | 46px | 0.9px |
...
### Quick Prompt
> "Based on the `tope 19 modern` design system, use the color palette and typography hierarchy above to generate a modern landing page with navigation, hero section, card grid, and form — output both light and dark themes."
