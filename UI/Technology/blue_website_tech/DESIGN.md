# Design System: cpts 843 bho

## 1. Visual Theme & Atmosphere

This template presents a structured, modular web design built on a black with pale vivid yellow canvas, using Blue as the primary accent for interactive elements. The typography is anchored by `Helvetica Neue`, creating a consistent reading experience. The type scale spans 12px to 24px across 8 levels.
...
- **Cyan** (`#45aed6`): CTAs, links, and interactive highlights
- **Cyan 2** (`#31708f`): CTAs, links, and interactive highlights
### Neutral
...
|------|------|------|--------|-------------|----------------|
| Display | Helvetica Neue, Helvetica, Arial, sans-serif | 14px | 700 | 1.428571 | normal |
| Heading | inherit | 12px | 400 | 1 | normal |
| Sub-heading | Raleway, sans-serif | 18px | 600 | 1.5 | normal |
| Body | sans-serif | 24px | 500 | inherit | normal |
| Caption | monospace, monospace | 16px | 300 | 30px | normal |
| Button | Glyphicons Halflings | 16px | 200 | 1.33 | normal |
| Mono | Glyphicons Halflings | 16px | 200 | 1.33 | normal |
| Label | Glyphicons Halflings | 16px | 200 | 1.33 | normal |
...
### Quick Prompt
> "Based on the `cpts 843 bho` design system, use the color palette and typography hierarchy above to generate a modern landing page with navigation, hero section, card grid, and form — output both light and dark themes."
