...
|------|------|------|--------|-------------|----------------|
| Display | -apple-system, BlinkMacSystemFont, Segoe UI, Roboto, Helvetica Neue, Arial, sans-serif, Apple Color Emoji, Segoe UI Emoji, Segoe UI Symbol | 16px | 700 | 1.5 | 1px |
| Heading | inherit | 20px | 400 | 1 | 2px |
| Sub-heading | Montserrat, sans-serif | 14px | normal | inherit | normal |
| Body | Open Sans, sans-serif | 16px | 300 | 1.2 | 0.5px |
| Caption | Verdana, Arial, sans-serif | 16px | 600 | 0 | 0.5px |
| Button | sans-serif | 16px | 500 | 1.8em | 0.5px |
| Mono | sans-serif | 16px | 500 | 1.8em | 0.5px |
| Label | sans-serif | 16px | 500 | 1.8em | 0.5px |
...
### Quick Prompt
> "Based on the `moban3443` design system, use the color palette and typography hierarchy above to generate a modern landing page with navigation, hero section, card grid, and form — output both light and dark themes."
