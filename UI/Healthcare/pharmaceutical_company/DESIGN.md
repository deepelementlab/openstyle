...
- **Vivid Red** (`#e20000`): CTAs, links, and interactive highlights
...
|------|------|------|--------|-------------|----------------|
| Display | Josefin Sans, sans-serif | 16px | 300 | 1.428571 | 1px |
| Heading | Glyphicons Halflings | 12px | bold | 1 | 5px |
| Sub-heading | Helvetica Neue, Helvetica, Arial, sans-serif | 14px | normal | 1.8em | 2px |
| Body | inherit | 18px | 400 | 2em | 2px |
| Caption | sans-serif | 16px | 500 | 1.5 | 2px |
| Button | monospace, monospace | 16px | 200 | 1.333333 | 2px |
| Mono | monospace, monospace | 16px | 200 | 1.333333 | 2px |
| Label | monospace, monospace | 16px | 200 | 1.333333 | 2px |
...
### Quick Prompt
> "Based on the `moban2193` design system, use the color palette and typography hierarchy above to generate a modern landing page with navigation, hero section, card grid, and form — output both light and dark themes."
