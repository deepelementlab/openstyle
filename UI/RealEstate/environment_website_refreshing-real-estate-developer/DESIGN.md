...
- **Green** (`#46bd55`): CTAs, links, and interactive highlights
...
| Heading | inherit | 13px | 400 | 1 | 0 |
| Sub-heading | sans-serif | 14px | 300 | 1.6em | 15px |
| Body | monospace, monospace | 18px | 600 | 1.5 | 15px |
| Caption | Helvetica Neue, Helvetica, Arial, sans-serif | 16px | bold | 1.33 | 15px |
| Button | Menlo, Monaco, Consolas, Courier New, monospace | 30px | 200 | 20px | 15px |
| Mono | Menlo, Monaco, Consolas, Courier New, monospace | 16px | 200 | 20px | 15px |
| Label | Menlo, Monaco, Consolas, Courier New, monospace | 24px | 200 | 20px | 15px |
...
### Quick Prompt
> "Based on the `ccps 12 MyHome` design system, use the color palette and typography hierarchy above to generate a modern landing page with navigation, hero section, card grid, and form — output both light and dark themes."
