...
- **Vivid Teal** (`#13d0ab`): CTAs, links, and interactive highlights
...
|------|------|------|--------|-------------|----------------|
| Display | Helvetica Neue, Helvetica, Arial, sans-serif | 12px | bold | 1.428571 | normal |
| Heading | inherit | 14px | normal | 1 | normal |
| Sub-heading | Muli, sans-serif | 18px | 500 | 1.5 | normal |
| Body | Montserrat, sans-serif | 16px | 300 | 1.333333 | normal |
| Caption | sans-serif | 16px | 200 | 2em | normal |
| Button | monospace, monospace | 16px | 100 | 30px | normal |
| Mono | monospace, monospace | 16px | 100 | 30px | normal |
| Label | monospace, monospace | 16px | 100 | 30px | normal |
...
### Quick Prompt
> "Based on the `cpts 937 brk` design system, use the color palette and typography hierarchy above to generate a modern landing page with navigation, hero section, card grid, and form — output both light and dark themes."
