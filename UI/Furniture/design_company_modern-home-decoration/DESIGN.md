# Design System: cpts 1910 czg

## 1. Visual Theme & Atmosphere

This template presents a structured, modular web design built on a mid gray with white canvas, using Vivid Blue as the primary accent for interactive elements. The typography is anchored by `Oswald`, creating a consistent reading experience. The type scale spans 14px to 20px across 8 levels.
...
- **Light Vivid Orange** (`#faad83`): CTAs, links, and interactive highlights
...
|------|------|------|--------|-------------|----------------|
| Display | Oswald, sans-serif | 20px | 400 | 1.5 | 2px |
| Heading | -apple-system, BlinkMacSystemFont, Segoe UI, Roboto, Helvetica Neue, Arial, sans-serif, Apple Color Emoji, Segoe UI Emoji, Segoe UI Symbol | 14px | 700 | 1 | 1px |
| Sub-heading | inherit | 16px | 300 | inherit | normal |
| Body | Pacifico, cursive | 16px | 600 | 1.2 | 0 |
| Caption | sans-serif | 16px | 500 | 2em | 0.5px |
| Button | monospace, monospace | 16px | bolder | 0 | 3px |
| Mono | monospace, monospace | 16px | bolder | 0 | 3px |
| Label | monospace, monospace | 16px | bolder | 0 | 3px |
...
### Quick Prompt
> "Based on the `cpts 1910 czg` design system, use the color palette and typography hierarchy above to generate a modern landing page with navigation, hero section, card grid, and form — output both light and dark themes."
