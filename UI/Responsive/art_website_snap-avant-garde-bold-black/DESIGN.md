...
- **Blue 2** (`#3496d8`): CTAs, links, and interactive highlights
...
| Caption | sans-serif | 13px | bold | 30px | 5px |
| Button | monospace, monospace | 21px | 600 | 46px | 5px |
| Mono | monospace, monospace | 16px | 600 | 46px | 5px |
...
### Quick Prompt
> "Based on the `well 9 snap` design system, use the color palette and typography hierarchy above to generate a modern landing page with navigation, hero section, card grid, and form — output both light and dark themes."
