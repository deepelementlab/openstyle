# Design System: moban2956

## 1. Visual Theme & Atmosphere

This template presents a structured, modular web design built on a black with pale vivid yellow canvas, using Soft Vivid Red as the primary accent for interactive elements. The typography is anchored by `Source Sans Pro`, creating a consistent reading experience. The type scale spans 12px to 18px across 8 levels.
...
### Accent
- **Soft Vivid Red** (`#ff688e`): CTAs, links, and interactive highlights
- **Blue** (`#3d59e8`): CTAs, links, and interactive highlights
...
| Heading | Monoton, cursive | 12px | bold | 1 | 2px |
| Sub-heading | Helvetica Neue, Helvetica, Arial, sans-serif | 16px | normal | 1.5 | 3px |
| Body | inherit | 18px | 600 | 2em | 0.5px |
| Caption | Oswald, sans-serif | 16px | 400 | 1.333333 | normal |
| Button | sans-serif | 16px | 500 | 30px | 0.7px |
| Mono | sans-serif | 17px | 500 | 30px | 0.7px |
| Label | sans-serif | 15px | 500 | 30px | 0.7px |
...
- Use `#ff688e` as the primary accent for CTAs and interactive elements.
...
### Quick Prompt
> "Based on the `moban2956` design system, use the color palette and typography hierarchy above to generate a modern landing page with navigation, hero section, card grid, and form — output both light and dark themes."

### Key Token Reference
- **Text:** Pale Vivid Yellow (`#fcf8e3`)
- **CTA / Accent:** Soft Vivid Red (`#ff688e`)
- **Border:** White (`#fff`)
