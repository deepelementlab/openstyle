# Design System: cpts 1275 cnq

## 1. Visual Theme & Atmosphere

This template presents a structured, modular web design built on a deep deep muted blue with pale green canvas, using Soft Vivid Amber as the primary accent for interactive elements. The typography is anchored by `Open Sans`, creating a consistent reading experience. The type scale spans 12px to 18px across 8 levels.
...
### Accent
- **Soft Vivid Amber** (`#fbb034`): CTAs, links, and interactive highlights
...
- **Dark Gray** (`#6a737b`): Border and divider color
...
|------|------|------|--------|-------------|----------------|
| Display | Open Sans, sans-serif | 16px | 600 | 1.428571 | 1px |
| Heading | inherit | 12px | normal | 1.8em | 1px |
| Sub-heading | sans-serif | 16px | bold | 1 | 1px |
| Body | monospace, monospace | 14px | 400 | 1.5 | 1px |
| Caption | Helvetica Neue, Helvetica, Arial, sans-serif | 18px | 300 | 0 | 1px |
| Button | Menlo, Monaco, Consolas, Courier New, monospace | 16px | 700 | 1.33 | 1px |
| Mono | Menlo, Monaco, Consolas, Courier New, monospace | 16px | 700 | 1.33 | 1px |
| Label | Menlo, Monaco, Consolas, Courier New, monospace | 16px | 700 | 1.33 | 1px |
...
- Use `#fbb034` as the primary accent for CTAs and interactive elements.
...
### Quick Prompt
> "Based on the `cpts 1275 cnq` design system, use the color palette and typography hierarchy above to generate a modern landing page with navigation, hero section, card grid, and form — output both light and dark themes."

### Key Token Reference
- **Text:** Deep Muted Blue (`#1B242F`)
- **CTA / Accent:** Soft Vivid Amber (`#fbb034`)
- **Border:** White (`#fff`)
