# Design System: hdsn 50 cleaning

## 1. Visual Theme & Atmosphere

This template presents a structured, modular web design built on a mid gray with white canvas, using Vivid Blue as the primary accent for interactive elements. The typography is anchored by `-apple-system`, creating a consistent reading experience. The type scale spans 14px to 25px across 8 levels.
...
- **Vivid Blue 2** (`#2c73e8`): CTAs, links, and interactive highlights
...
| Sub-heading | inherit | 16px | 300 | 1.2 | normal |
| Body | sans-serif | 16px | 500 | 1 | normal |
| Caption | Lato, sans-serif | 16px | bolder | 0 | normal |
| Button | Font Awesome 5 Brands | 24px | bold | 1.15 | normal |
| Mono | Font Awesome 5 Brands | 16px | bold | 1.15 | normal |
| Label | Font Awesome 5 Brands | 25px | bold | 1.15 | normal |
...
| 4 | `0 0 0 1px #fff, 0 0 0 0.2rem rgba(0, 123, 255, 0.25)` |
| 5 | `0 0 0 0.2rem rgba(38, 143, 255, 0.5)` |
| 6 | `0 0 0 0.2rem rgba(130, 138, 145, 0.5)` |
| 7 | `0 0 0 0.2rem rgba(72, 180, 97, 0.5)` |
| 8 | `0 0 0 0.2rem rgba(58, 176, 195, 0.5)` |
...
### Quick Prompt
> "Based on the `hdsn 50 cleaning` design system, use the color palette and typography hierarchy above to generate a modern landing page with navigation, hero section, card grid, and form — output both light and dark themes."
