...
- **White 4** (`rgba(255,255,255,.5)`): Structural background
### Semantic
...
|------|------|------|--------|-------------|----------------|
| Display | -apple-system, BlinkMacSystemFont, Segoe UI, Roboto, Helvetica Neue, Arial, sans-serif, Apple Color Emoji, Segoe UI Emoji, Segoe UI Symbol | 16px | 400 | 1.5 | normal |
| Heading | inherit | 20px | 700 | 1 | 0 |
| Sub-heading | SFMono-Regular, Menlo, Monaco, Consolas, Liberation Mono, Courier New, monospace | 14px | 300 | 1.2 | 0 |
| Body | sans-serif | 16px | 500 | inherit | 0 |
| Caption | monospace, monospace | 16px | 100 | 0 | 0 |
| Button | Noto Serif, sans-serif | 16px | normal | 1.15 | 0 |
| Mono | Noto Serif, sans-serif | 16px | normal | 1.15 | 0 |
| Label | Noto Serif, sans-serif | 16px | normal | 1.15 | 0 |
...
### Quick Prompt
> "Based on the `hdsn 36 adsiter` design system, use the color palette and typography hierarchy above to generate a modern landing page with navigation, hero section, card grid, and form — output both light and dark themes."
