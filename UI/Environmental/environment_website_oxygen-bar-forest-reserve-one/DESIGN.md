# Design System: mzth 10 sanza

## 1. Visual Theme & Atmosphere

This template presents a structured, modular web design built on a black with pale vivid yellow canvas, using Blue as the primary accent for interactive elements. The typography is anchored by `Helvetica Neue`, creating a consistent reading experience. The type scale spans 10px to 18px across 8 levels.
...
- **Green** (`#23AD21`): CTAs, links, and interactive highlights
### Neutral
...
|------|------|------|--------|-------------|----------------|
| Display | Helvetica Neue, Helvetica, Arial, sans-serif | 12px | 700 | 1.428571 | 1px |
| Heading | Open Sans, sans-serif | 14px | 400 | 1 | 2px |
| Sub-heading | inherit | 18px | 500 | 1.5 | normal |
| Body | Open Sans, Sans-serif | 16px | 300 | 1.333333 | 0.2px |
| Caption | Roboto, sans-serif | 13px | 800 | 30px | 0.4px |
| Button | sans-serif | 16px | 900 | 46px | -3px |
| Mono | sans-serif | 10px | 900 | 46px | -3px |
| Label | sans-serif | 16px | 900 | 46px | -3px |
...
### Quick Prompt
> "Based on the `mzth 10 sanza` design system, use the color palette and typography hierarchy above to generate a modern landing page with navigation, hero section, card grid, and form — output both light and dark themes."
