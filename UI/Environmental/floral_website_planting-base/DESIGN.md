# Design System: moban3483

## 1. Visual Theme & Atmosphere

This template presents a structured, modular web design built on a mid gray with white canvas, using Vivid Blue as the primary accent for interactive elements. The typography is anchored by `Niconne`, creating a consistent reading experience. The type scale spans 14px to 40px across 8 levels.
...
|------|------|------|--------|-------------|----------------|
| Display | Niconne, cursive | 20px | 400 | 1.5 | 1px |
| Heading | -apple-system, BlinkMacSystemFont, Segoe UI, Roboto, Helvetica Neue, Arial, sans-serif, Apple Color Emoji, Segoe UI Emoji, Segoe UI Symbol | 14px | 300 | 1.2 | normal |
| Sub-heading | inherit | 16px | 600 | 1 | 2px |
| Body | Lato, sans-serif | 16px | 700 | inherit | 2px |
| Caption | sans-serif | 16px | 500 | 0 | 2px |
| Button | monospace, monospace | 15px | bolder | 1.15 | 2px |
| Mono | monospace, monospace | 40px | bolder | 1.15 | 2px |
| Label | monospace, monospace | 16px | bolder | 1.15 | 2px |
...
### Quick Prompt
> "Based on the `moban3483` design system, use the color palette and typography hierarchy above to generate a modern landing page with navigation, hero section, card grid, and form — output both light and dark themes."
