# Design System: moban2427

## 1. Visual Theme & Atmosphere

This template presents a structured, modular web design built on a mid gray with pale vivid yellow canvas, using Blue as the primary accent for interactive elements. The typography is anchored by `Glyphicons Halflings`, creating a consistent reading experience. The type scale spans 12px to 30px across 8 levels.
...
- **Green** (`#4FC242`): CTAs, links, and interactive highlights
...
- **Soft Pink** (`#C76994`): CTAs, links, and interactive highlights
### Neutral
...
| Heading | Helvetica Neue, Helvetica, Arial, sans-serif | 12px | bold | 1 | 3px |
| Sub-heading | Work Sans, sans-serif | 18px | normal | 2em | 1px |
| Body | inherit | 16px | 300 | 1.5 | 5px |
| Caption | Open Sans, sans-serif | 16px | 400 | 1.333333 | 8px |
| Button | sans-serif | 30px | 500 | 1.4 | 8px |
| Mono | sans-serif | 13px | 500 | 1.4 | 8px |
| Label | sans-serif | 16px | 500 | 1.4 | 8px |
...
### Quick Prompt
> "Based on the `moban2427` design system, use the color palette and typography hierarchy above to generate a modern landing page with navigation, hero section, card grid, and form — output both light and dark themes."
