...
- **Lime** (`#7aba1e`): CTAs, links, and interactive highlights
...
|------|------|------|--------|-------------|----------------|
| Display | Slide-icons | 12px | 600 | 1.428571 | 1px |
| Heading | Helvetica Neue, Helvetica, Arial, sans-serif | 14px | bold | 1 | 2px |
| Sub-heading | Open Sans, sans-serif | 18px | normal | 2em | 3px |
| Body | inherit | 16px | 700 | 1.5 | 5px |
| Caption | sans-serif | 16px | 500 | 30px | 4px |
| Button | monospace, monospace | 16px | 300 | 1.333333 | 18px |
| Mono | monospace, monospace | 16px | 300 | 1.333333 | 18px |
| Label | monospace, monospace | 16px | 300 | 1.333333 | 18px |
...
### Quick Prompt
> "Based on the `cpts 1626 cqw` design system, use the color palette and typography hierarchy above to generate a modern landing page with navigation, hero section, card grid, and form — output both light and dark themes."
