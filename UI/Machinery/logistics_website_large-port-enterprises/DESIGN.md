# Design System: cpts 1852 dus

## 1. Visual Theme & Atmosphere

This template presents a structured, modular web design built on a mid gray with white canvas, using Vivid Blue as the primary accent for interactive elements. The typography is anchored by `Poppins`, creating a consistent reading experience. The type scale spans 14px to 20px across 8 levels.
...
- **Vivid Orange** (`#ff4e00`): CTAs, links, and interactive highlights
...
|------|------|------|--------|-------------|----------------|
| Display | Poppins, sans-serif | 20px | 600 | 1.5 | 1px |
| Heading | -apple-system, BlinkMacSystemFont, Segoe UI, Roboto, Helvetica Neue, Arial, sans-serif, Apple Color Emoji, Segoe UI Emoji, Segoe UI Symbol | 14px | 400 | 1 | normal |
| Sub-heading | inherit | 16px | 700 | inherit | 2px |
| Body | Font Awesome 5 Free | 16px | 300 | 1.2 | 4px |
| Caption | sans-serif | 16px | 500 | 0 | 3px |
| Button | monospace, monospace | 16px | bolder | 2em | 3px |
| Mono | monospace, monospace | 16px | bolder | 2em | 3px |
| Label | monospace, monospace | 16px | bolder | 2em | 3px |
...
### Quick Prompt
> "Based on the `cpts 1852 dus` design system, use the color palette and typography hierarchy above to generate a modern landing page with navigation, hero section, card grid, and form — output both light and dark themes."
