# Design System: moban4351

## 1. Visual Theme & Atmosphere

This template presents a structured, modular web design built on a mid gray with white canvas, using Vivid Green as the primary accent for interactive elements. The typography is anchored by `-apple-system`, creating a consistent reading experience. The type scale spans 14px to 20px across 8 levels.
...
### Accent
- **Vivid Green** (`#05BB59`): CTAs, links, and interactive highlights
...
- **Blue** (`#343EAF`): CTAs, links, and interactive highlights
...
|------|------|------|--------|-------------|----------------|
| Display | -apple-system, BlinkMacSystemFont, Segoe UI, Roboto, Helvetica Neue, Arial, Noto Sans, sans-serif, Apple Color Emoji, Segoe UI Emoji, Segoe UI Symbol, Noto Color Emoji | 16px | 700 | 1.5 | normal |
| Heading | Roboto, sans-serif | 14px | 500 | 30px | 2px |
| Sub-heading | SFMono-Regular, Menlo, Monaco, Consolas, Liberation Mono, Courier New, monospace | 20px | 400 | inherit | 2px |
| Body | Font Awesome 5 Brands | 16px | 300 | 1 | 2px |
| Caption | Font Awesome 5 Free | 20px | bolder | 1.2 | 2px |
| Button | sans-serif | 16px | 900 | 55px | 2px |
| Mono | sans-serif | 18px | 900 | 55px | 2px |
| Label | sans-serif | 15px | 900 | 55px | 2px |
...
- Use `#05BB59` as the primary accent for CTAs and interactive elements.
...
### Quick Prompt
> "Based on the `moban4351` design system, use the color palette and typography hierarchy above to generate a modern landing page with navigation, hero section, card grid, and form — output both light and dark themes."

### Key Token Reference
- **Text:** White (`#fff`)
- **CTA / Accent:** Vivid Green (`#05BB59`)
- **Border:** White 2 (`#fff`)
