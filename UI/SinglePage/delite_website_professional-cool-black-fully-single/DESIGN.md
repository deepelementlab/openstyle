# Design System: like 5 Show Love In MUSIC

## 1. Visual Theme & Atmosphere

This template presents a structured, modular web design built on a black with light green canvas, using Pink as the primary accent for interactive elements. The typography is anchored by `Oswald`, creating a consistent reading experience. The type scale spans 12px to 30px across 8 levels.
...
### Accent
- **Pink** (`#A43E89`): CTAs, links, and interactive highlights
...
|------|------|------|--------|-------------|----------------|
| Display | Oswald, sans-serif | 18px | bold | 1.428571 | 1px |
| Heading | inherit | 14px | normal | 1 | 1px |
| Sub-heading | Helvetica Neue, Helvetica, Arial, sans-serif | 12px | 200 | 1.5 | 1px |
| Body | Open Sans, sans-serif | 24px | 300 | 1.33 | 1px |
| Caption | sans-serif | 16px | 400 | 20px | 1px |
| Button | monospace, serif | 16px | 500 | 1em | 1px |
| Mono | monospace, serif | 30px | 500 | 1em | 1px |
| Label | monospace, serif | 21px | 500 | 1em | 1px |
...
- Use `#A43E89` as the primary accent for CTAs and interactive elements.
...
### Quick Prompt
> "Based on the `like 5 Show Love In MUSIC` design system, use the color palette and typography hierarchy above to generate a modern landing page with navigation, hero section, card grid, and form — output both light and dark themes."

### Key Token Reference
- **Text:** Light Green (`#d6e9c6`)
- **CTA / Accent:** Pink (`#A43E89`)
- **Border:** White (`#fff`)
