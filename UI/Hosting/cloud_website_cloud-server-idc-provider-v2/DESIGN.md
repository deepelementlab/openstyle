# Design System: cpts 920 bqr

## 1. Visual Theme & Atmosphere

This template presents a structured, modular web design built on a black with pale green canvas, using Blue as the primary accent for interactive elements. The typography is anchored by `Noto Serif`, creating a consistent reading experience. The type scale spans 12px to 30px across 8 levels.
...
- **Blue 2** (`#1976d2`): CTAs, links, and interactive highlights
...
| Sub-heading | et-line | 13px | 300 | 1.6em | 15px |
| Body | sans-serif | 18px | bold | 1.5 | 15px |
| Caption | monospace, monospace | 16px | 600 | 1.33 | 15px |
| Button | Helvetica Neue, Helvetica, Arial, sans-serif | 30px | 200 | 20px | 15px |
| Mono | Helvetica Neue, Helvetica, Arial, sans-serif | 20px | 200 | 20px | 15px |
| Label | Helvetica Neue, Helvetica, Arial, sans-serif | 16px | 200 | 20px | 15px |
...
### Quick Prompt
> "Based on the `cpts 920 bqr` design system, use the color palette and typography hierarchy above to generate a modern landing page with navigation, hero section, card grid, and form — output both light and dark themes."
