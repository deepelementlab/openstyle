...
- **Vivid Cyan** (`#00bcd4`): CTAs, links, and interactive highlights
...
- **Black** (`#1e1e1e`): Structural background
...
|------|------|------|--------|-------------|----------------|
| Display | -apple-system, BlinkMacSystemFont, Segoe UI, Roboto, Helvetica Neue, Arial, sans-serif, Apple Color Emoji, Segoe UI Emoji, Segoe UI Symbol, Noto Color Emoji | 15px | 700 | 1.5 | 0.5px |
| Heading | SFMono-Regular, Menlo, Monaco, Consolas, Liberation Mono, Courier New, monospace | 20px | 400 | inherit | normal |
| Sub-heading | inherit | 14px | 500 | 1.2 | 1px |
| Body | sans-serif | 14px | 300 | 1 | 1px |
| Caption | Roboto, sans-serif | 16px | 600 | 50px | 1px |
| Button | FontAwesome | 16px | bolder | 0 | 1px |
| Mono | FontAwesome | 19px | bolder | 0 | 1px |
| Label | FontAwesome | 16px | bolder | 0 | 1px |
...
### Quick Prompt
> "Based on the `dance 51 yeid` design system, use the color palette and typography hierarchy above to generate a modern landing page with navigation, hero section, card grid, and form — output both light and dark themes."
