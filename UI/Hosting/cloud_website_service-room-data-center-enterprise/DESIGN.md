# Design System: hdsn 54 dataweb

## 1. Visual Theme & Atmosphere

This template presents a structured, modular web design built on a deep deep blue with white canvas, using Vivid Blue as the primary accent for interactive elements. The typography is anchored by `Poppins`, creating a consistent reading experience. The type scale spans 14px to 24px across 8 levels.
...
### Primary
- **Deep Blue** (`#0c0f38`): Primary text color
### Accent
...
|------|------|------|--------|-------------|----------------|
| Display | Poppins | 16px | 400 | 1.5 | normal |
| Heading | -apple-system, BlinkMacSystemFont, Segoe UI, Roboto, Helvetica Neue, Arial, sans-serif, Apple Color Emoji, Segoe UI Emoji, Segoe UI Symbol | 20px | 300 | 1 | 0 |
| Sub-heading | inherit | 14px | 700 | 1.2 | 0 |
| Body | SFMono-Regular, Menlo, Monaco, Consolas, Liberation Mono, Courier New, monospace | 16px | bold | inherit | 0 |
| Caption | sans-serif | 16px | 500 | 30px | 0 |
| Button | monospace, monospace | 16px | normal | 24px | 0 |
| Mono | monospace, monospace | 16px | normal | 24px | 0 |
| Label | monospace, monospace | 24px | normal | 24px | 0 |
...
### Quick Prompt
> "Based on the `hdsn 54 dataweb` design system, use the color palette and typography hierarchy above to generate a modern landing page with navigation, hero section, card grid, and form — output both light and dark themes."

### Key Token Reference
- **Text:** Deep Blue (`#0c0f38`)
