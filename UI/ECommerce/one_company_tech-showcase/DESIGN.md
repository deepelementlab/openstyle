# Design System: dstp 15 hr2

## 1. Visual Theme & Atmosphere

This template presents a structured, modular web design built on a mid gray with pale vivid yellow canvas, using Vivid Red as the primary accent for interactive elements. The typography is anchored by `Helvetica Neue`, creating a consistent reading experience. The type scale spans 12px to 24px across 8 levels.
...
### Accent
- **Vivid Red** (`#BE1414`): CTAs, links, and interactive highlights
- **Blue** (`#337ab7`): CTAs, links, and interactive highlights
- **Cyan** (`#2caab3`): CTAs, links, and interactive highlights
- **Cyan 2** (`#2c8cb3`): CTAs, links, and interactive highlights
...
|------|------|------|--------|-------------|----------------|
| Display | Helvetica Neue, Helvetica, Arial, sans-serif | 12px | 700 | 1.428571 | normal |
| Heading | inherit | 14px | 400 | 1 | normal |
| Sub-heading | Roboto, sans-serif | 18px | 500 | 1.5 | normal |
| Body | sans-serif | 24px | 300 | 20px | normal |
| Caption | monospace, monospace | 16px | 200 | 0 | normal |
| Button | Glyphicons Halflings | 16px | 600 | inherit | normal |
| Mono | Glyphicons Halflings | 16px | 600 | inherit | normal |
| Label | Glyphicons Halflings | 16px | 600 | inherit | normal |
...
- Use `#BE1414` as the primary accent for CTAs and interactive elements.
...
### Quick Prompt
> "Based on the `dstp 15 hr2` design system, use the color palette and typography hierarchy above to generate a modern landing page with navigation, hero section, card grid, and form — output both light and dark themes."

### Key Token Reference
- **Text:** Pale Vivid Yellow (`#fcf8e3`)
- **CTA / Accent:** Vivid Red (`#BE1414`)
- **Border:** White (`#fff`)
