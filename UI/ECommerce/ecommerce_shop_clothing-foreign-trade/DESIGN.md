# Design System: fish 2 aviato

## 1. Visual Theme & Atmosphere

This template presents a structured, modular web design built on a black with pale vivid yellow canvas, using Blue as the primary accent for interactive elements. The typography is anchored by `themefisher-font`, creating a consistent reading experience. The type scale spans 10px to 30px across 8 levels.
...
- Primary typeface: `themefisher-font`
...
- **Blue 2** (`#286090`): CTAs, links, and interactive highlights
### Neutral
...
|------|------|------|--------|-------------|----------------|
| Display | themefisher-font | 12px | 400 | 1.428571 | 1px |
| Heading | Helvetica Neue, Helvetica, Arial, sans-serif | 14px | 200 | 1 | 2px |
| Sub-heading | Poppins, sans-serif | 18px | 700 | 1.5 | normal |
| Body | inherit | 16px | 300 | 1.333333 | 0.5px |
| Caption | slick | 13px | 600 | 30px | 0.5px |
| Button | sans-serif | 20px | 500 | 0 | 0.5px |
| Mono | sans-serif | 10px | 500 | 0 | 0.5px |
| Label | sans-serif | 30px | 500 | 0 | 0.5px |
...
- Use `themefisher-font` as the base font family to preserve the template's typographic identity.
...
### Quick Prompt
> "Based on the `fish 2 aviato` design system, use the color palette and typography hierarchy above to generate a modern landing page with navigation, hero section, card grid, and form — output both light and dark themes."
