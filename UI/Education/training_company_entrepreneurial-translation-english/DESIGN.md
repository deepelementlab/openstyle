...
| Heading | Helvetica Neue, Helvetica, Arial, sans-serif | 14px | 700 | 1 | normal |
| Sub-heading | sans-serif | 18px | 600 | 1.5 | normal |
| Body | monospace, monospace | 16px | bold | 30px | normal |
| Caption | Glyphicons Halflings | 13px | normal | 1.333333 | normal |
| Button | inherit | 16px | 500 | 0 | normal |
| Mono | inherit | 16px | 500 | 0 | normal |
| Label | inherit | 16px | 500 | 0 | normal |
...
| 4 | `0 1px 1px rgba(0, 0, 0, 0.05)` |
| 5 | `inset 1px 0 0 0 rgba(0, 0, 0, 0.01)` |
...
### Quick Prompt
> "Based on the `tops 54 Bizium` design system, use the color palette and typography hierarchy above to generate a modern landing page with navigation, hero section, card grid, and form — output both light and dark themes."
