# Design System: moban3153

## 1. Visual Theme & Atmosphere

This template presents a structured, modular web design built on a mid gray with white canvas, using Soft Vivid Blue as the primary accent for interactive elements. The typography is anchored by `-apple-system`, creating a consistent reading experience. The type scale spans 14px to 28px across 8 levels.
...
### Accent
- **Soft Vivid Blue** (`#42a5f5`): CTAs, links, and interactive highlights
...
|------|------|------|--------|-------------|----------------|
| Display | -apple-system, BlinkMacSystemFont, Segoe UI, Roboto, Helvetica Neue, Arial, sans-serif, Apple Color Emoji, Segoe UI Emoji, Segoe UI Symbol | 15px | 400 | 1.5 | 1px |
| Heading | inherit | 14px | 700 | 1 | 2px |
| Sub-heading | Open Sans, sans-serif | 20px | 300 | inherit | normal |
| Body | Font Awesome 5 Free | 14px | 600 | 1.2 | 6px |
| Caption | sans-serif | 16px | 500 | 2em | 0.5px |
| Button | monospace, monospace | 16px | bold | 1.9 | 3px |
| Mono | monospace, monospace | 16px | bold | 1.9 | 3px |
| Label | monospace, monospace | 28px | bold | 1.9 | 3px |
...
- Use `#42a5f5` as the primary accent for CTAs and interactive elements.
...
### Quick Prompt
> "Based on the `moban3153` design system, use the color palette and typography hierarchy above to generate a modern landing page with navigation, hero section, card grid, and form — output both light and dark themes."

### Key Token Reference
- **Text:** White (`#fff`)
- **CTA / Accent:** Soft Vivid Blue (`#42a5f5`)
- **Border:** White 2 (`#fff`)
