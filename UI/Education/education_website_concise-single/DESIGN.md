# Design System: cpts 1381 chl

## 1. Visual Theme & Atmosphere

This template presents a structured, modular web design built on a black with pale vivid yellow canvas, using Blue as the primary accent for interactive elements. The typography is anchored by `Poiret One`, creating a consistent reading experience. The type scale spans 12px to 38px across 8 levels.
...
- **Soft Amber** (`#d4ab5c`): CTAs, links, and interactive highlights
...
|------|------|------|--------|-------------|----------------|
| Display | Poiret One, cursive | 14px | 400 | 1.428571 | normal |
| Heading | Helvetica Neue, Helvetica, Arial, sans-serif | 12px | normal | 30px | 0.85px |
| Sub-heading | Muli, sans-serif | 18px | 700 | 1 | 2px |
| Body | inherit | 16px | 300 | 1.5 | 1px |
| Caption | sans-serif | 20px | bold | 1.333333 | 1px |
| Button | monospace, monospace | 17px | 500 | normal | 1px |
| Mono | monospace, monospace | 38px | 500 | normal | 1px |
| Label | monospace, monospace | 30px | 500 | normal | 1px |
...
- Use `Poiret One` as the base font family to preserve the template's typographic identity.
...
### Quick Prompt
> "Based on the `cpts 1381 chl` design system, use the color palette and typography hierarchy above to generate a modern landing page with navigation, hero section, card grid, and form — output both light and dark themes."
