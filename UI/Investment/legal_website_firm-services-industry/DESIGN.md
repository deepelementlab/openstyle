# Design System: cpts 1233 bxw

## 1. Visual Theme & Atmosphere

This template presents a structured, modular web design built on a deep deep muted blue with pale green canvas, using Soft Red as the primary accent for interactive elements. The typography is anchored by `Open Sans`, creating a consistent reading experience. The type scale spans 12px to 18px across 7 levels.
...
### Accent
- **Soft Red** (`#E75C5D`): CTAs, links, and interactive highlights
...
- **Soft Vivid Red** (`#F94B4B`): CTAs, links, and interactive highlights
### Neutral
...
|------|------|------|--------|-------------|----------------|
| Display | Open Sans, sans-serif | 12px | 400 | 1.428571 | 0.1em |
| Heading | inherit | 14px | 700 | 1.7em | 0.1em |
| Sub-heading | FontAwesome | 16px | bold | 1 | 0.1em |
| Body | sans-serif | 18px | normal | 1.5 | 0.1em |
| Caption | monospace, monospace | 16px | 600 | 1.5em | 0.1em |
| Button | Helvetica Neue, Helvetica, Arial, sans-serif | 16px | 300 | 1.8em | 0.1em |
| Mono | Helvetica Neue, Helvetica, Arial, sans-serif | 16px | 300 | 1.8em | 0.1em |
| Label | Helvetica Neue, Helvetica, Arial, sans-serif | 0.0 | 300 | 1.8em | 0.1em |
...
- Use `#E75C5D` as the primary accent for CTAs and interactive elements.
...
### Quick Prompt
> "Based on the `cpts 1233 bxw` design system, use the color palette and typography hierarchy above to generate a modern landing page with navigation, hero section, card grid, and form — output both light and dark themes."

### Key Token Reference
- **Text:** Deep Muted Blue (`#1B242F`)
- **CTA / Accent:** Soft Red (`#E75C5D`)
- **Border:** White (`#fff`)
