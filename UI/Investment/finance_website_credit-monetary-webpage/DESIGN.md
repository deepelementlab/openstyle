# Design System: moban2739

## 1. Visual Theme & Atmosphere

This template presents a structured, modular web design built on a black with pale vivid yellow canvas, using Vivid Blue as the primary accent for interactive elements. The typography is anchored by `Helvetica Neue`, creating a consistent reading experience. The type scale spans 12px to 18px across 8 levels.
...
### Accent
- **Vivid Blue** (`#026fbf`): CTAs, links, and interactive highlights
...
|------|------|------|--------|-------------|----------------|
| Display | Helvetica Neue, Helvetica, Arial, sans-serif | 12px | 600 | 1.428571 | 1px |
| Heading | inherit | 16px | bold | 1 | 0.5px |
| Sub-heading | Source Sans Pro, sans-serif | 14px | normal | 1.5 | 2px |
| Body | sans-serif | 16px | 700 | 1.333333 | normal |
| Caption | monospace, monospace | 18px | 300 | 30px | 1.5px |
| Button | Glyphicons Halflings | 16px | 800 | 46px | 0 |
| Mono | Glyphicons Halflings | 16px | 800 | 46px | 0 |
| Label | Glyphicons Halflings | 16px | 800 | 46px | 0 |
...
- Use `#026fbf` as the primary accent for CTAs and interactive elements.
...
### Quick Prompt
> "Based on the `moban2739` design system, use the color palette and typography hierarchy above to generate a modern landing page with navigation, hero section, card grid, and form — output both light and dark themes."

### Key Token Reference
- **Text:** Pale Vivid Yellow (`#fcf8e3`)
- **CTA / Accent:** Vivid Blue (`#026fbf`)
- **Border:** White (`#fff`)
