...
- **Soft Teal** (`#50d8af`): CTAs, links, and interactive highlights
...
|------|------|------|--------|-------------|----------------|
| Display | -apple-system, BlinkMacSystemFont, Segoe UI, Roboto, Helvetica Neue, Arial, sans-serif, Apple Color Emoji, Segoe UI Emoji, Segoe UI Symbol | 20px | 700 | 1.5 | normal |
| Heading | Montserrat, sans-serif | 14px | 400 | 1 | 1px |
| Sub-heading | Raleway, sans-serif | 16px | 300 | 0 | 1px |
| Body | inherit | 16px | normal | inherit | 1px |
| Caption | Ionicons | 14px | bold | 1.2 | 1px |
| Button | sans-serif | 16px | 600 | 18px | 1px |
| Mono | sans-serif | 16px | 600 | 18px | 1px |
| Label | sans-serif | 13px | 600 | 18px | 1px |
...
### Quick Prompt
> "Based on the `twts 240 reveal` design system, use the color palette and typography hierarchy above to generate a modern landing page with navigation, hero section, card grid, and form — output both light and dark themes."
