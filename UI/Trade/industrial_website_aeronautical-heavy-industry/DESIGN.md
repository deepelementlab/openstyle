...
- **Vivid Red** (`#f01140`): CTAs, links, and interactive highlights
- **Indigo** (`#7542aa`): CTAs, links, and interactive highlights
...
| Heading | Helvetica Neue, Helvetica, Arial, sans-serif | 12px | normal | 1 | 5px |
| Sub-heading | inherit | 15px | bold | 2em | 3px |
| Body | Yanone Kaffeesatz, sans-serif | 18px | 300 | 1.5 | 10px |
| Caption | sans-serif | 16px | 700 | 40px | 10px |
| Button | monospace, monospace | 30px | 400 | 1.333333 | 10px |
| Mono | monospace, monospace | 20px | 400 | 1.333333 | 10px |
| Label | monospace, monospace | 16px | 400 | 1.333333 | 10px |
...
### Quick Prompt
> "Based on the `cpts 1534 csk` design system, use the color palette and typography hierarchy above to generate a modern landing page with navigation, hero section, card grid, and form — output both light and dark themes."
