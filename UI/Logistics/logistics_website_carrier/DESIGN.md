...
- **Soft Vivid Amber** (`#ffdc39`): CTAs, links, and interactive highlights
...
|------|------|------|--------|-------------|----------------|
| Display | -apple-system, BlinkMacSystemFont, Segoe UI, Roboto, Helvetica Neue, Arial, sans-serif, Apple Color Emoji, Segoe UI Emoji, Segoe UI Symbol | 15px | 500 | 1.5 | 1px |
| Heading | Rubik, sans-serif | 16px | 300 | 1 | 2px |
| Sub-heading | inherit | 20px | 400 | 2em | normal |
| Body | sans-serif | 14px | 600 | inherit | 5px |
| Caption | monospace, monospace | 16px | 700 | 1.2 | 0.6px |
| Button | SFMono-Regular, Menlo, Monaco, Consolas, Liberation Mono, Courier New, monospace | 16px | bolder | 1.8em | 0.6px |
| Mono | SFMono-Regular, Menlo, Monaco, Consolas, Liberation Mono, Courier New, monospace | 16px | bolder | 1.8em | 0.6px |
| Label | SFMono-Regular, Menlo, Monaco, Consolas, Liberation Mono, Courier New, monospace | 16px | bolder | 1.8em | 0.6px |
...
### Quick Prompt
> "Based on the `moban4309` design system, use the color palette and typography hierarchy above to generate a modern landing page with navigation, hero section, card grid, and form — output both light and dark themes."
