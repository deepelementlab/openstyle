...
- **Vivid Amber** (`#f1a70c`): CTAs, links, and interactive highlights
...
| Heading | Helvetica Neue, Helvetica, Arial, sans-serif | 12px | bold | 1 | 1px |
| Sub-heading | Montserrat, sans-serif | 16px | normal | 2em | 3px |
| Body | inherit | 16px | 300 | 30px | 4px |
| Caption | sans-serif | 16px | 400 | 1.5 | 1.5px |
| Button | monospace, monospace | 16px | 500 | 1.8em | 1.5px |
| Mono | monospace, monospace | 18px | 500 | 1.8em | 1.5px |
| Label | monospace, monospace | 16px | 500 | 1.8em | 1.5px |
...
### Quick Prompt
> "Based on the `cpts 1673 cmi` design system, use the color palette and typography hierarchy above to generate a modern landing page with navigation, hero section, card grid, and form — output both light and dark themes."
