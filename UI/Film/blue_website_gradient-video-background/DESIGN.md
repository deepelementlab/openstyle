# Design System: moban3684

## 1. Visual Theme & Atmosphere

This template presents a structured, modular web design built on a mid gray with white canvas, using Vivid Blue as the primary accent for interactive elements. The typography is anchored by `-apple-system`, creating a consistent reading experience. The type scale spans 14px to 32px across 8 levels.
...
- **Soft Vivid Blue** (`#4096ee`): CTAs, links, and interactive highlights
### Neutral
...
|------|------|------|--------|-------------|----------------|
| Display | -apple-system, BlinkMacSystemFont, Segoe UI, Roboto, Helvetica Neue, Arial, sans-serif, Apple Color Emoji, Segoe UI Emoji, Segoe UI Symbol, Noto Color Emoji | 20px | 700 | 1.5 | normal |
| Heading | SFMono-Regular, Menlo, Monaco, Consolas, Liberation Mono, Courier New, monospace | 14px | 300 | 1.2 | 0.02em |
| Sub-heading | inherit | 16px | 400 | inherit | 0.02em |
| Body | sans-serif | 16px | 600 | 1 | 0.02em |
| Caption | arial, helvetica, sans-serif | 16px | 500 | 0 | 0.02em |
| Button | arial, helvetica, sans-serif | 14px | bolder | 50px | 0.02em |
| Mono | arial, helvetica, sans-serif | 32px | bolder | 50px | 0.02em |
| Label | arial, helvetica, sans-serif | 16px | bolder | 50px | 0.02em |
...
### Quick Prompt
> "Based on the `moban3684` design system, use the color palette and typography hierarchy above to generate a modern landing page with navigation, hero section, card grid, and form — output both light and dark themes."
