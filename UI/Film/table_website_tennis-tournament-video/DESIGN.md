...
| Button | sans-serif | 16px | 400 | 0 | 12px |
| Mono | sans-serif | 16px | 400 | 0 | 12px |
| Label | sans-serif | 16px | 400 | 0 | 12px |
...
### Quick Prompt
> "Based on the `moban2417` design system, use the color palette and typography hierarchy above to generate a modern landing page with navigation, hero section, card grid, and form — output both light and dark themes."
