# Design System: cpts 1273 cme

## 1. Visual Theme & Atmosphere

This template presents a structured, modular web design built on a deep deep muted blue with pale green canvas, using Vivid Amber as the primary accent for interactive elements. The typography is anchored by `Open Sans`, creating a consistent reading experience. The type scale spans 12px to 18px across 8 levels.
...
### Accent
- **Vivid Amber** (`#FFC01D`): CTAs, links, and interactive highlights
- **Vivid Blue** (`#104F94`): CTAs, links, and interactive highlights
...
|------|------|------|--------|-------------|----------------|
| Display | Open Sans, sans-serif | 16px | normal | 1.428571 | 1px |
| Heading | Oswald, sans-serif | 12px | bold | 1 | 1px |
| Sub-heading | inherit | 14px | 600 | 1.8em | 1px |
| Body | sans-serif | 18px | 400 | 1.5 | 1px |
| Caption | monospace, monospace | 16px | 500 | 1.33 | 1px |
| Button | Helvetica Neue, Helvetica, Arial, sans-serif | 16px | 200 | 20px | 1px |
| Mono | Helvetica Neue, Helvetica, Arial, sans-serif | 16px | 200 | 20px | 1px |
| Label | Helvetica Neue, Helvetica, Arial, sans-serif | 16px | 200 | 20px | 1px |
...
- Use `#FFC01D` as the primary accent for CTAs and interactive elements.
...
### Quick Prompt
> "Based on the `cpts 1273 cme` design system, use the color palette and typography hierarchy above to generate a modern landing page with navigation, hero section, card grid, and form — output both light and dark themes."

### Key Token Reference
- **Text:** Deep Muted Blue (`#1B242F`)
- **CTA / Accent:** Vivid Amber (`#FFC01D`)
- **Border:** White (`#fff`)
