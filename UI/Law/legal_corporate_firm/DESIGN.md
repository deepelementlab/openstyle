...
| Heading | inherit | 14px | bold | 1 | 3px |
| Sub-heading | Roboto, sans-serif | 18px | normal | 1.5 | 2px |
| Body | sans-serif | 16px | 700 | 32px | 13px |
| Caption | monospace, monospace | 16px | 800 | 1.333333 | 23px |
| Button | Glyphicons Halflings | 16px | 500 | 30px | 4px |
| Mono | Glyphicons Halflings | 16px | 500 | 30px | 4px |
| Label | Glyphicons Halflings | 16px | 500 | 30px | 4px |
...
### Quick Prompt
> "Based on the `cpts 1613 ckw` design system, use the color palette and typography hierarchy above to generate a modern landing page with navigation, hero section, card grid, and form — output both light and dark themes."
