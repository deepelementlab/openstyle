# Design System: moban2272

## 1. Visual Theme & Atmosphere

This template presents a structured, modular web design built on a black with pale vivid yellow canvas, using Blue as the primary accent for interactive elements. The typography is anchored by `Helvetica Neue`, creating a consistent reading experience. The type scale spans 12px to 18px across 8 levels.
...
- **Vivid Blue** (`#0064d2`): CTAs, links, and interactive highlights
...
- **Vivid Amber** (`#f5af02`): CTAs, links, and interactive highlights
### Neutral
...
|------|------|------|--------|-------------|----------------|
| Display | Helvetica Neue, Helvetica, Arial, sans-serif | 12px | bold | 1.428571 | 1px |
| Heading | inherit | 16px | normal | 1 | 2px |
| Sub-heading | Open Sans, sans-serif | 14px | 600 | 1.5 | 10px |
| Body | Faster One, cursive | 16px | 400 | 2em | 12px |
| Caption | sans-serif | 18px | 300 | 1.333333 | 9px |
| Button | monospace, monospace | 16px | 500 | 30px | 5px |
| Mono | monospace, monospace | 15px | 500 | 30px | 5px |
| Label | monospace, monospace | 16px | 500 | 30px | 5px |
...
### Quick Prompt
> "Based on the `moban2272` design system, use the color palette and typography hierarchy above to generate a modern landing page with navigation, hero section, card grid, and form — output both light and dark themes."
