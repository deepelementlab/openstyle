# Design System: cpts 1676 cnm

## 1. Visual Theme & Atmosphere

This template presents a structured, modular web design built on a black with pale vivid yellow canvas, using Soft Vivid Amber as the primary accent for interactive elements. The typography is anchored by `Glyphicons Halflings`, creating a consistent reading experience. The type scale spans 12px to 18px across 8 levels.
...
### Accent
- **Soft Vivid Amber** (`#ffcc54`): CTAs, links, and interactive highlights
...
| Heading | Helvetica Neue, Helvetica, Arial, sans-serif | 12px | 400 | 1 | 2px |
| Sub-heading | inherit | 16px | bold | 1.5 | 3px |
| Body | Montserrat, sans-serif | 15px | normal | 30px | normal |
| Caption | sans-serif | 18px | 600 | 1.333333 | 0.5px |
| Button | monospace, monospace | 16px | 500 | 28px | 4px |
| Mono | monospace, monospace | 16px | 500 | 28px | 4px |
| Label | monospace, monospace | 16px | 500 | 28px | 4px |
...
- Use `#ffcc54` as the primary accent for CTAs and interactive elements.
...
### Quick Prompt
> "Based on the `cpts 1676 cnm` design system, use the color palette and typography hierarchy above to generate a modern landing page with navigation, hero section, card grid, and form — output both light and dark themes."

### Key Token Reference
- **Text:** Pale Vivid Yellow (`#fcf8e3`)
- **CTA / Accent:** Soft Vivid Amber (`#ffcc54`)
- **Border:** White (`#fff`)
