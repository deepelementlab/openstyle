...
- **Vivid Orange** (`#fa8c17`): CTAs, links, and interactive highlights
### Neutral
...
| Heading | inherit | 20px | 500 | 1 | 0 |
| Sub-heading | SFMono-Regular, Menlo, Monaco, Consolas, Liberation Mono, Courier New, monospace | 14px | 300 | 1.2 | 0 |
| Body | sans-serif | 16px | normal | inherit | 0 |
| Caption | monospace, monospace | 16px | 700 | 25px | 0 |
| Button | Poppins, sans-serif | 18px | bold | 28px | 0 |
| Mono | Poppins, sans-serif | 16px | bold | 28px | 0 |
| Label | Poppins, sans-serif | 16px | bold | 28px | 0 |
...
### Quick Prompt
> "Based on the `hdsn 30 milina` design system, use the color palette and typography hierarchy above to generate a modern landing page with navigation, hero section, card grid, and form — output both light and dark themes."
