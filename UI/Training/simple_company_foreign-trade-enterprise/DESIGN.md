...
- **Dark Vivid Blue** (`#005490`): CTAs, links, and interactive highlights
...
|------|------|------|--------|-------------|----------------|
| Display | Raleway, sans-serif | 14px | 400 | 1.428571 | 0.4px |
| Heading | Open Sans, sans-serif | 16px | 700 | 20px | 0 |
| Sub-heading | Helvetica Neue, Helvetica, Arial, sans-serif | 12px | 600 | 1 | -1px |
| Body | inherit | 18px | normal | 1.5 | 1px |
| Caption | sans-serif | 16px | 500 | 46px | 1px |
| Button | monospace, monospace | 16px | 300 | inherit | 1px |
| Mono | monospace, monospace | 16px | 300 | inherit | 1px |
| Label | monospace, monospace | 30px | 300 | inherit | 1px |
...
### Quick Prompt
> "Based on the `cpts 814 bgl` design system, use the color palette and typography hierarchy above to generate a modern landing page with navigation, hero section, card grid, and form — output both light and dark themes."
