...
- **Soft Vivid Red** (`#ff4f81`): CTAs, links, and interactive highlights
### Neutral
...
| Sub-heading | Hind, sans-serif | 15px | 300 | inherit | normal |
| Body | Font Awesome 5 Free | 16px | 600 | 1.2 | 3px |
| Caption | sans-serif | 16px | 500 | 0 | 4px |
| Button | monospace, monospace | 17px | bolder | 1.4 | 4px |
| Mono | monospace, monospace | 16px | bolder | 1.4 | 4px |
| Label | monospace, monospace | 16px | bolder | 1.4 | 4px |
...
### Quick Prompt
> "Based on the `cpts 1859 emm` design system, use the color palette and typography hierarchy above to generate a modern landing page with navigation, hero section, card grid, and form — output both light and dark themes."
