# Design System: templatemo 468 onetel
...
| Body | monospace, monospace | 16px | 500 | 1.333333 | normal |
| Caption | Glyphicons Halflings | 16px | 300 | 30px | normal |
...
| Label | Menlo, Monaco, Consolas, Courier New, monospace | 13px | 200 | 46px | normal |
...
### Quick Prompt
> "Based on the `templatemo 468 onetel` design system, use the color palette and typography hierarchy above to generate a modern landing page with navigation, hero section, card grid, and form — output both light and dark themes."
