# Design System: sbtp 67 triangle

## 1. Visual Theme & Atmosphere

This template presents a structured, modular web design built on a mid gray with pale vivid yellow canvas, using Blue as the primary accent for interactive elements. The typography is anchored by `Helvetica Neue`, creating a consistent reading experience. The type scale spans 12px to 36px across 8 levels.
...
- **Vivid Cyan** (`#00aeef`): CTAs, links, and interactive highlights
- **Vivid Cyan 2** (`#0099AE`): CTAs, links, and interactive highlights
### Neutral
...
|------|------|------|--------|-------------|----------------|
| Display | Helvetica Neue, Helvetica, Arial, sans-serif | 18px | 300 | 1.428571 | 5px |
| Heading | inherit | 12px | 700 | 1 | 3px |
| Sub-heading | Lato, sans-serif | 14px | 400 | 0 | 0 |
| Body | Open Sans, sans-serif | 16px | 500 | 1.5 | 0 |
| Caption | Noto Sans, sans-serif | 36px | 200 | 30px | 0 |
| Button | sans-serif | 24px | normal | 1.333333 | 0 |
| Mono | sans-serif | 20px | normal | 1.333333 | 0 |
| Label | sans-serif | 16px | normal | 1.333333 | 0 |
...
### Quick Prompt
> "Based on the `sbtp 67 triangle` design system, use the color palette and typography hierarchy above to generate a modern landing page with navigation, hero section, card grid, and form — output both light and dark themes."
