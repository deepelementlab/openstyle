...
| Sub-heading | Alegreya SC | 14px | 500 | 1.5 | normal |
| Body | sans-serif | 16px | 300 | 1.333333 | normal |
| Caption | monospace, monospace | 16px | 200 | 30px | normal |
| Button | Glyphicons Halflings | 16px | 200 | 46px | normal |
| Mono | Glyphicons Halflings | 16px | 200 | 46px | normal |
| Label | Glyphicons Halflings | 21px | 200 | 46px | normal |
...
### Quick Prompt
> "Based on the `moban2585` design system, use the color palette and typography hierarchy above to generate a modern landing page with navigation, hero section, card grid, and form — output both light and dark themes."
