...
- **Vivid Blue** (`#28a7e9`): CTAs, links, and interactive highlights
...
|------|------|------|--------|-------------|----------------|
| Display | Helvetica Neue, Helvetica, Arial, sans-serif | 12px | 400 | 1.428571 | normal |
| Heading | inherit | 14px | 700 | 1 | normal |
| Sub-heading | sans-serif | 18px | bold | 1.5 | normal |
| Body | monospace, monospace | 16px | 300 | 1.333333 | normal |
| Caption | Glyphicons Halflings | 16px | 500 | 30px | normal |
...
| Label | Menlo, Monaco, Consolas, Courier New, monospace | 21px | 200 | 46px | normal |
...
### Quick Prompt
> "Based on the `moban2547` design system, use the color palette and typography hierarchy above to generate a modern landing page with navigation, hero section, card grid, and form — output both light and dark themes."
