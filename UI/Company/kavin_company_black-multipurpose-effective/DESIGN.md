...
- **Red 2** (`#D92222`): CTAs, links, and interactive highlights
...
| Heading | Noto Serif, serif | 12px | 400 | 1 | 1px |
| Sub-heading | inherit | 13px | 300 | 1.6em | 1px |
| Body | Open Sans, Arial, sans-serif | 18px | normal | 30px | 1px |
| Caption | sans-serif | 16px | 600 | 1em | 1px |
| Button | monospace, monospace | 30px | bold | 1.5 | 1px |
| Mono | monospace, monospace | 20px | bold | 1.5 | 1px |
| Label | monospace, monospace | 16px | bold | 1.5 | 1px |
...
### Quick Prompt
> "Based on the `syt 9 kavin` design system, use the color palette and typography hierarchy above to generate a modern landing page with navigation, hero section, card grid, and form — output both light and dark themes."
