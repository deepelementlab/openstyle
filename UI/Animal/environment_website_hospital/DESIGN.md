# Design System: cpts 839 blg

## 1. Visual Theme & Atmosphere

This template presents a structured, modular web design built on a deep dark red with pale vivid yellow canvas, using Blue as the primary accent for interactive elements. The typography is anchored by `Comfortaa`, creating a consistent reading experience. The type scale spans 12px to 20px across 8 levels.

**Key Characteristics:**
- Uses container-based layout wrappers.
- Grid system detected via column classes.
- Sectioned page architecture with repeated blocks.
- Primary typeface: `Comfortaa`
...
### Primary
- **Dark Red** (`#6b0f24`): Primary text color
...
- **Deep Green** (`#193725`): CTAs, links, and interactive highlights
...
|------|------|------|--------|-------------|----------------|
| Display | Comfortaa, cursive | 14px | bold | 1.428571 | 1px |
| Heading | Helvetica Neue, Helvetica, Arial, sans-serif | 12px | 400 | 1.8em | 1px |
| Sub-heading | inherit | 18px | normal | 1 | 1px |
| Body | sans-serif | 16px | 300 | 1.5 | 1px |
| Caption | monospace, monospace | 16px | 700 | 1.333333 | 1px |
| Button | Glyphicons Halflings | 16px | 500 | 30px | 1px |
| Mono | Glyphicons Halflings | 20px | 500 | 30px | 1px |
| Label | Glyphicons Halflings | 16px | 500 | 30px | 1px |
...
- Use `Comfortaa` as the base font family to preserve the template's typographic identity.
...
### Quick Prompt
> "Based on the `cpts 839 blg` design system, use the color palette and typography hierarchy above to generate a modern landing page with navigation, hero section, card grid, and form — output both light and dark themes."

### Key Token Reference
- **Text:** Dark Red (`#6b0f24`)
