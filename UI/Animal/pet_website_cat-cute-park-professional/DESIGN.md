...
- **Soft Vivid Red** (`#ff3535`): CTAs, links, and interactive highlights
...
|------|------|------|--------|-------------|----------------|
| Display | Helvetica Neue, Helvetica, Arial, sans-serif | 12px | normal | 1.428571 | 1px |
| Heading | inherit | 14px | bold | 1 | 2px |
| Sub-heading | Raleway, sans-serif | 18px | 600 | 1.5 | 3px |
| Body | Lato, sans-serif | 16px | 300 | 30px | normal |
| Caption | Molle, cursive | 16px | 500 | 1.333333 | 4px |
| Button | sans-serif | 16px | 200 | 46px | 10px |
| Mono | sans-serif | 16px | 200 | 46px | 10px |
| Label | sans-serif | 30px | 200 | 46px | 10px |
...
### Quick Prompt
> "Based on the `cpts 1744 crd` design system, use the color palette and typography hierarchy above to generate a modern landing page with navigation, hero section, card grid, and form — output both light and dark themes."
