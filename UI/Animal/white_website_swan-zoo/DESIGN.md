...
- **Soft Vivid Red** (`#ee4f4f`): CTAs, links, and interactive highlights
...
- **Vivid Blue** (`#168eea`): CTAs, links, and interactive highlights
### Neutral
...
| Heading | Open Sans, sans-serif | 14px | normal | 1 | 3px |
| Sub-heading | inherit | 16px | 600 | 2em | 5px |
| Body | sans-serif | 18px | 500 | 1.5 | 2px |
| Caption | monospace, monospace | 16px | 300 | 0 | 4px |
| Button | Glyphicons Halflings | 16px | 800 | 30px | 14px |
| Mono | Glyphicons Halflings | 16px | 800 | 30px | 14px |
| Label | Glyphicons Halflings | 15px | 800 | 30px | 14px |
...
### Quick Prompt
> "Based on the `moban2195` design system, use the color palette and typography hierarchy above to generate a modern landing page with navigation, hero section, card grid, and form — output both light and dark themes."
