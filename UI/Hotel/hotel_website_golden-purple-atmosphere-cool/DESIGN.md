# Design System: syt 4 golden hotel
...
- **Vivid Amber** (`#F6CC07`): CTAs, links, and interactive highlights
...
|------|------|------|--------|-------------|----------------|
| Display | Helvetica Neue, Helvetica, Arial, sans-serif | 14px | 700 | 1.428571 | 5px |
| Heading | inherit | 12px | 400 | 1 | 13px |
| Sub-heading | Raleway, sans-serif | 18px | 300 | 1.5 | 4px |
| Body | sans-serif | 16px | 600 | 20px | 4px |
| Caption | monospace, monospace | 24px | 500 | inherit | 4px |
| Button | Glyphicons Halflings | 16px | 200 | 30px | 4px |
| Mono | Glyphicons Halflings | 16px | 200 | 30px | 4px |
| Label | Glyphicons Halflings | 16px | 200 | 30px | 4px |
...
### Quick Prompt
> "Based on the `syt 4 golden hotel` design system, use the color palette and typography hierarchy above to generate a modern landing page with navigation, hero section, card grid, and form — output both light and dark themes."
