...
- **Vivid Cyan** (`#19b9e7`): CTAs, links, and interactive highlights
...
| Heading | Roboto, sans-serif | 18px | 700 | 1 | normal |
| Sub-heading | inherit | 14px | 300 | 30px | normal |
| Body | sans-serif | 16px | 500 | 1.5 | normal |
| Caption | monospace, monospace | 16px | 200 | 1.333333 | normal |
| Button | Glyphicons Halflings | 16px | 100 | 46px | normal |
| Mono | Glyphicons Halflings | 16px | 100 | 46px | normal |
| Label | Glyphicons Halflings | 16px | 100 | 46px | normal |
...
### Quick Prompt
> "Based on the `form 2` design system, use the color palette and typography hierarchy above to generate a modern landing page with navigation, hero section, card grid, and form — output both light and dark themes."
