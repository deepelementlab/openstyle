...
| Heading | inherit | 18px | 700 | 1 | normal |
| Sub-heading | sans-serif | 14px | 300 | 1.5 | normal |
| Body | monospace, monospace | 16px | 500 | 30px | normal |
| Caption | Glyphicons Halflings | 16px | 200 | 1.333333 | normal |
| Button | Menlo, Monaco, Consolas, Courier New, monospace | 16px | 100 | 46px | normal |
| Mono | Menlo, Monaco, Consolas, Courier New, monospace | 21px | 100 | 46px | normal |
| Label | Menlo, Monaco, Consolas, Courier New, monospace | 16px | 100 | 46px | normal |
...
### Quick Prompt
> "Based on the `moban2774` design system, use the color palette and typography hierarchy above to generate a modern landing page with navigation, hero section, card grid, and form — output both light and dark themes."
