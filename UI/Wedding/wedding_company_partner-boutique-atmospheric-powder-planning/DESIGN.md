...
- **Red 2** (`#db4766`): CTAs, links, and interactive highlights
...
| Heading | sans-serif | 12px | 700 | 1 | 3px |
| Sub-heading | inherit | 18px | 500 | 1.5 | 5px |
| Body | flexslider-icon | 30px | 300 | 1.333333 | 5px |
| Caption | Great Vibes, cursive | 16px | bold | 30px | 5px |
| Button | monospace, monospace | 13px | 600 | 46px | 5px |
| Mono | monospace, monospace | 21px | 600 | 46px | 5px |
| Label | monospace, monospace | 16px | 600 | 46px | 5px |
...
### Quick Prompt
> "Based on the `wait 87 wedding` design system, use the color palette and typography hierarchy above to generate a modern landing page with navigation, hero section, card grid, and form — output both light and dark themes."
