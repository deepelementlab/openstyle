# Design System: moban2833

## 1. Visual Theme & Atmosphere

This template presents a structured, modular web design built on a black with pale vivid yellow canvas, using Vivid Pink as the primary accent for interactive elements. The typography is anchored by `Glyphicons Halflings`, creating a consistent reading experience. The type scale spans 12px to 20px across 8 levels.
...
### Accent
- **Vivid Pink** (`#ff0a80`): CTAs, links, and interactive highlights
...
|------|------|------|--------|-------------|----------------|
| Display | Glyphicons Halflings | 14px | 400 | 1.428571 | 1px |
| Heading | Helvetica Neue, Helvetica, Arial, sans-serif | 12px | 600 | 1 | 2px |
| Sub-heading | Josefin Sans, sans-serif | 16px | 700 | 1.5 | 0.5px |
| Body | inherit | 18px | 300 | 30px | 4px |
| Caption | sans-serif | 16px | 500 | 1.333333 | normal |
| Button | monospace, monospace | 15px | 200 | 2em | 5px |
| Mono | monospace, monospace | 16px | 200 | 2em | 5px |
| Label | monospace, monospace | 20px | 200 | 2em | 5px |
...
- Use `#ff0a80` as the primary accent for CTAs and interactive elements.
...
### Quick Prompt
> "Based on the `moban2833` design system, use the color palette and typography hierarchy above to generate a modern landing page with navigation, hero section, card grid, and form — output both light and dark themes."

### Key Token Reference
- **Text:** Pale Vivid Yellow (`#fcf8e3`)
- **CTA / Accent:** Vivid Pink (`#ff0a80`)
- **Border:** White (`#fff`)
