# Design System: tops 98 Mind Craft
...
- **Soft Red** (`#e1666a`): CTAs, links, and interactive highlights
...
| Sub-heading | sans-serif | 18px | 500 | 1.5 | 2px |
| Body | monospace, monospace | 16px | 300 | 1.333333 | 2px |
| Caption | Glyphicons Halflings | 21px | 200 | 0 | 2px |
| Button | Menlo, Monaco, Consolas, Courier New, monospace | 16px | normal | 30px | 2px |
| Mono | Menlo, Monaco, Consolas, Courier New, monospace | 16px | normal | 30px | 2px |
| Label | Menlo, Monaco, Consolas, Courier New, monospace | 16px | normal | 30px | 2px |
...
### Quick Prompt
> "Based on the `tops 98 Mind Craft` design system, use the color palette and typography hierarchy above to generate a modern landing page with navigation, hero section, card grid, and form — output both light and dark themes."
