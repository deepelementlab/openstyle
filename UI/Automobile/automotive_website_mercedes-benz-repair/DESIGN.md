...
- **Vivid Indigo** (`#490bf9`): CTAs, links, and interactive highlights
...
|------|------|------|--------|-------------|----------------|
| Display | -apple-system, BlinkMacSystemFont, Segoe UI, Roboto, Helvetica Neue, Arial, Noto Sans, sans-serif, Apple Color Emoji, Segoe UI Emoji, Segoe UI Symbol, Noto Color Emoji | 20px | 400 | 1.5 | 2px |
| Heading | SFMono-Regular, Menlo, Monaco, Consolas, Liberation Mono, Courier New, monospace | 14px | 700 | inherit | normal |
| Sub-heading | Rubik, sans-serif | 16px | 300 | 1 | 1px |
| Body | Righteous, cursive | 17px | bolder | 1.2 | 8px |
| Caption | sans-serif | 16px | normal | 0 | 8px |
| Button | inherit | 16px | 600 | 18px | 8px |
| Mono | inherit | 16px | 600 | 18px | 8px |
| Label | inherit | 24px | 600 | 18px | 8px |
...
### Quick Prompt
> "Based on the `moban4094` design system, use the color palette and typography hierarchy above to generate a modern landing page with navigation, hero section, card grid, and form — output both light and dark themes."
