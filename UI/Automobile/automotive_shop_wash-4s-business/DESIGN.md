...
- **Soft Vivid Red** (`#ff5252`): CTAs, links, and interactive highlights
### Neutral
...
| Body | Font Awesome 5 Free | 16px | bolder | 1.2 | normal |
| Caption | sans-serif | 14px | 500 | 0 | normal |
| Button | monospace, monospace | 16px | bold | 1.9 | normal |
| Mono | monospace, monospace | 16px | bold | 1.9 | normal |
| Label | monospace, monospace | 16px | bold | 1.9 | normal |
...
### Quick Prompt
> "Based on the `cpts 1848 dko` design system, use the color palette and typography hierarchy above to generate a modern landing page with navigation, hero section, card grid, and form — output both light and dark themes."
