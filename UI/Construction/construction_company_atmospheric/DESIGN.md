# Design System: moban2636

## 1. Visual Theme & Atmosphere

This template presents a structured, modular web design built on a mid gray with pale vivid yellow canvas, using Vivid Red as the primary accent for interactive elements. The typography is anchored by `Glyphicons Halflings`, creating a consistent reading experience. The type scale spans 12px to 20px across 8 levels.
...
|------|------|------|--------|-------------|----------------|
| Display | Glyphicons Halflings | 14px | 600 | 1.428571 | 2px |
| Heading | Helvetica Neue, Helvetica, Arial, sans-serif | 12px | 300 | 1 | 3px |
| Sub-heading | inherit | 16px | bold | 1.5 | 1px |
| Body | sans-serif | 18px | normal | 1.333333 | 4px |
| Caption | monospace, monospace | 16px | 400 | 20px | 4px |
| Button | Menlo, Monaco, Consolas, Courier New, monospace | 16px | 100 | 1.4 | 4px |
| Mono | Menlo, Monaco, Consolas, Courier New, monospace | 16px | 100 | 1.4 | 4px |
| Label | Menlo, Monaco, Consolas, Courier New, monospace | 20px | 100 | 1.4 | 4px |
...
### Quick Prompt
> "Based on the `moban2636` design system, use the color palette and typography hierarchy above to generate a modern landing page with navigation, hero section, card grid, and form — output both light and dark themes."
