# Design System: moban2257

## 1. Visual Theme & Atmosphere

This template presents a structured, modular web design built on a black with pale vivid yellow canvas, using Blue as the primary accent for interactive elements. The typography is anchored by `Muli`, creating a consistent reading experience. The type scale spans 12px to 21px across 8 levels.
...
- **Soft Vivid Red** (`#ff2f68`): CTAs, links, and interactive highlights
- **Vivid Cyan** (`#00bfff`): CTAs, links, and interactive highlights
...
|------|------|------|--------|-------------|----------------|
| Display | Muli, sans-serif | 12px | 600 | 1.428571 | 2px |
| Heading | Helvetica Neue, Helvetica, Arial, sans-serif | 14px | bold | 1 | 1px |
| Sub-heading | inherit | 18px | normal | 1.5 | 0.5px |
| Body | sans-serif | 16px | 300 | 30px | 4px |
| Caption | monospace, monospace | 13px | 400 | 1.333333 | 3px |
| Button | Glyphicons Halflings | 16px | 500 | 46px | 0.7px |
| Mono | Glyphicons Halflings | 16px | 500 | 46px | 0.7px |
| Label | Glyphicons Halflings | 21px | 500 | 46px | 0.7px |
...
### Quick Prompt
> "Based on the `moban2257` design system, use the color palette and typography hierarchy above to generate a modern landing page with navigation, hero section, card grid, and form — output both light and dark themes."
