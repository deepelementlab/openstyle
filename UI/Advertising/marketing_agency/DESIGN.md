# Design System: moban2274

## 1. Visual Theme & Atmosphere

This template presents a structured, modular web design built on a mid gray with pale vivid yellow canvas, using Blue as the primary accent for interactive elements. The typography is anchored by `Helvetica Neue`, creating a consistent reading experience. The type scale spans 12px to 30px across 8 levels.
...
- **Green** (`#22e27d`): CTAs, links, and interactive highlights
...
- **Black 2** (`#111`): Structural background
...
|------|------|------|--------|-------------|----------------|
| Display | Helvetica Neue, Helvetica, Arial, sans-serif | 12px | bold | 1.428571 | 2px |
| Heading | inherit | 14px | normal | 1 | 1px |
| Sub-heading | Hind Vadodara, sans-serif | 16px | 300 | 1.5 | 5px |
| Body | FontAwesome | 18px | 500 | 1.333333 | 3px |
| Caption | sans-serif | 16px | 200 | 30px | 3px |
| Button | monospace, monospace | 16px | 600 | 46px | 3px |
| Mono | monospace, monospace | 30px | 600 | 46px | 3px |
| Label | monospace, monospace | 16px | 600 | 46px | 3px |
...
### Quick Prompt
> "Based on the `moban2274` design system, use the color palette and typography hierarchy above to generate a modern landing page with navigation, hero section, card grid, and form — output both light and dark themes."
