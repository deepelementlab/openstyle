# Design System: cpts 1421 ccq

## 1. Visual Theme & Atmosphere

This template presents a structured, modular web design built on a mid gray with pale vivid yellow canvas, using Blue as the primary accent for interactive elements. The typography is anchored by `Raleway`, creating a consistent reading experience. The type scale spans 12px to 45px across 8 levels.
...
|------|------|------|--------|-------------|----------------|
| Display | Raleway, sans-serif | 12px | 700 | 1.428571 | 2px |
| Heading | inherit | 14px | 400 | 1 | 3px |
| Sub-heading | sans-serif | 18px | 600 | 30px | 1px |
| Body | monospace, monospace | 30px | 500 | 46px | 1px |
| Caption | Glyphicons Halflings | 45px | 300 | 1.5 | 1px |
| Button | Helvetica Neue, Helvetica, Arial, sans-serif | 13px | 200 | 1.33 | 1px |
| Mono | Helvetica Neue, Helvetica, Arial, sans-serif | 16px | 200 | 1.33 | 1px |
| Label | Helvetica Neue, Helvetica, Arial, sans-serif | 16px | 200 | 1.33 | 1px |
...
### Quick Prompt
> "Based on the `cpts 1421 ccq` design system, use the color palette and typography hierarchy above to generate a modern landing page with navigation, hero section, card grid, and form — output both light and dark themes."
