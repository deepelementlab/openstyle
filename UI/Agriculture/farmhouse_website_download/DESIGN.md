# Design System: cpts 1718 cup

## 1. Visual Theme & Atmosphere

This template presents a structured, modular web design built on a mid gray with pale vivid yellow canvas, using Vivid Orange as the primary accent for interactive elements. The typography is anchored by `Glyphicons Halflings`, creating a consistent reading experience. The type scale spans 12px to 18px across 8 levels.
...
### Accent
- **Vivid Orange** (`#fa5d07`): CTAs, links, and interactive highlights
...
|------|------|------|--------|-------------|----------------|
| Display | Glyphicons Halflings | 14px | 600 | 1.428571 | 1px |
| Heading | Helvetica Neue, Helvetica, Arial, sans-serif | 12px | bold | 1 | 2px |
| Sub-heading | inherit | 18px | normal | 2em | 0.5px |
| Body | Raleway, sans-serif | 16px | 300 | 1.5 | 1.5px |
| Caption | sans-serif | 16px | 400 | 30px | 3px |
| Button | monospace, monospace | 16px | 700 | 1.333333 | 3px |
| Mono | monospace, monospace | 15px | 700 | 1.333333 | 3px |
| Label | monospace, monospace | 16px | 700 | 1.333333 | 3px |
...
- Use `#fa5d07` as the primary accent for CTAs and interactive elements.
...
### Quick Prompt
> "Based on the `cpts 1718 cup` design system, use the color palette and typography hierarchy above to generate a modern landing page with navigation, hero section, card grid, and form — output both light and dark themes."

### Key Token Reference
- **Text:** Pale Vivid Yellow (`#fcf8e3`)
- **CTA / Accent:** Vivid Orange (`#fa5d07`)
- **Border:** White (`#fff`)
