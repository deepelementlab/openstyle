# Design System: moban4283

## 1. Visual Theme & Atmosphere

This template presents a structured, modular web design built on a charcoal with pale vivid yellow canvas, using Soft Vivid Blue as the primary accent for interactive elements. The typography is anchored by `Helvetica Neue`, creating a consistent reading experience. The type scale spans 12px to 36px across 8 levels.
...
### Accent
- **Soft Vivid Blue** (`#6195FF`): CTAs, links, and interactive highlights
...
| Heading | inherit | 12px | 700 | 1 | normal |
| Sub-heading | sans-serif | 18px | 500 | 1.5 | normal |
| Body | monospace, monospace | 36px | 300 | 0 | normal |
| Caption | Glyphicons Halflings | 16px | 200 | 1.333333 | normal |
| Button | Menlo, Monaco, Consolas, Courier New, monospace | 21px | 200 | 50px | normal |
| Mono | Menlo, Monaco, Consolas, Courier New, monospace | 16px | 200 | 50px | normal |
| Label | Menlo, Monaco, Consolas, Courier New, monospace | 16px | 200 | 50px | normal |
...
- Use `#6195FF` as the primary accent for CTAs and interactive elements.
...
### Quick Prompt
> "Based on the `moban4283` design system, use the color palette and typography hierarchy above to generate a modern landing page with navigation, hero section, card grid, and form — output both light and dark themes."

### Key Token Reference
- **Text:** Pale Vivid Yellow (`#fcf8e3`)
- **CTA / Accent:** Soft Vivid Blue (`#6195FF`)
- **Border:** White (`#fff`)
