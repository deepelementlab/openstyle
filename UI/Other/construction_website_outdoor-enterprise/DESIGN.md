...
- **Vivid Amber** (`#ffa100`): CTAs, links, and interactive highlights
- **Vivid Cyan** (`#0087c9`): CTAs, links, and interactive highlights
...
| Sub-heading | Roboto Condensed, sans-serif | 14px | 600 | 1.5 | normal |
| Body | sans-serif | 18px | 500 | 1.333333 | 3px |
| Caption | monospace, monospace | 16px | 700 | 30px | 4px |
| Button | Glyphicons Halflings | 16px | 300 | 46px | 5px |
| Mono | Glyphicons Halflings | 16px | 300 | 46px | 5px |
| Label | Glyphicons Halflings | 16px | 300 | 46px | 5px |
...
### Quick Prompt
> "Based on the `moban2593` design system, use the color palette and typography hierarchy above to generate a modern landing page with navigation, hero section, card grid, and form — output both light and dark themes."
