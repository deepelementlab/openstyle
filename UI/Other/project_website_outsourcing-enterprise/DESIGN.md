...
- **Soft Blue** (`#4d6de3`): CTAs, links, and interactive highlights
...
| Sub-heading | Montserrat, sans-serif | 14px | 300 | 1.5 | normal |
| Body | Flaticon | 24px | 100 | 30px | normal |
| Caption | sans-serif | 15px | 600 | 1.333333 | normal |
| Button | monospace, monospace | 30px | 500 | 34px | normal |
| Mono | monospace, monospace | 16px | 500 | 34px | normal |
| Label | monospace, monospace | 13px | 500 | 34px | normal |
...
### Quick Prompt
> "Based on the `moban2949` design system, use the color palette and typography hierarchy above to generate a modern landing page with navigation, hero section, card grid, and form — output both light and dark themes."
