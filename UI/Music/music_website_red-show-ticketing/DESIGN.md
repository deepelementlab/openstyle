...
- **Red** (`#da1b2d`): CTAs, links, and interactive highlights
...
| Body | sans-serif | 16px | 500 | 1.333333 | 1px |
| Caption | monospace, monospace | 13px | 300 | 30px | 5px |
| Button | Glyphicons Halflings | 21px | 600 | 46px | 5px |
| Mono | Glyphicons Halflings | 16px | 600 | 46px | 5px |
...
### Quick Prompt
> "Based on the `cpts 1580 dve` design system, use the color palette and typography hierarchy above to generate a modern landing page with navigation, hero section, card grid, and form — output both light and dark themes."
