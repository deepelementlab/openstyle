# Design System: well 10 tunes music
...
- **Vivid Red** (`#e7185c`): CTAs, links, and interactive highlights
...
| Sub-heading | flexslider-icon | 18px | 500 | 1.5 | 7px |
| Body | Open Sans, Arial, sans-serif | 13px | 600 | 1.333333 | 1px |
| Caption | sans-serif | 16px | 300 | 30px | 5px |
| Button | monospace, monospace | 21px | bold | 46px | 5px |
| Mono | monospace, monospace | 16px | bold | 46px | 5px |
| Label | monospace, monospace | 30px | bold | 46px | 5px |
...
### Quick Prompt
> "Based on the `well 10 tunes music` design system, use the color palette and typography hierarchy above to generate a modern landing page with navigation, hero section, card grid, and form — output both light and dark themes."
