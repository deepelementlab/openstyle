# Design System: cpts 1505 crs

## 1. Visual Theme & Atmosphere

This template presents a structured, modular web design built on a black with pale vivid yellow canvas, using Blue as the primary accent for interactive elements. The typography is anchored by `Josefin Sans`, creating a consistent reading experience. The type scale spans 12px to 18px across 8 levels.
...
- **Soft Vivid Indigo** (`#8e3cfe`): CTAs, links, and interactive highlights
...
### Font Families
- `"Josefin Sans", sans-serif` (Primary)
...
|------|------|------|--------|-------------|----------------|
| Display | Josefin Sans, sans-serif | 12px | normal | 1.428571 | 2px |
| Heading | Helvetica Neue, Helvetica, Arial, sans-serif | 16px | bold | 1 | 4px |
| Sub-heading | sans-serif | 14px | 700 | 30px | 1px |
| Body | inherit | 18px | 600 | 1.5 | 6px |
| Caption | monospace, monospace | 16px | 400 | 1.8em | 6px |
| Button | Glyphicons Halflings | 16px | 500 | 1.333333 | 6px |
| Mono | Glyphicons Halflings | 16px | 500 | 1.333333 | 6px |
| Label | Glyphicons Halflings | 16px | 500 | 1.333333 | 6px |
...
- Use `Josefin Sans` as the base font family to preserve the template's typographic identity.
...
### Quick Prompt
> "Based on the `cpts 1505 crs` design system, use the color palette and typography hierarchy above to generate a modern landing page with navigation, hero section, card grid, and form — output both light and dark themes."
