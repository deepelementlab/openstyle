...
- **Vivid Pink** (`#e8206b`): CTAs, links, and interactive highlights
### Neutral
...
| Heading | sans-serif | 12px | 700 | 1 | 2px |
| Sub-heading | inherit | 18px | 500 | 1.5 | 0 |
| Body | flexslider-icon | 30px | 300 | 1.333333 | 5px |
| Caption | monospace, monospace | 16px | bold | 30px | 5px |
| Button | Glyphicons Halflings | 13px | 600 | 46px | 5px |
| Mono | Glyphicons Halflings | 21px | 600 | 46px | 5px |
| Label | Glyphicons Halflings | 16px | 600 | 46px | 5px |
...
### Quick Prompt
> "Based on the `moban2844` design system, use the color palette and typography hierarchy above to generate a modern landing page with navigation, hero section, card grid, and form — output both light and dark themes."
