# Design System: meme 15 spotlight
...
- **Soft Vivid Pink** (`#F05DA3`): CTAs, links, and interactive highlights
...
| Heading | inherit | 12px | 700 | 1 | 7px |
| Sub-heading | flexslider-icon | 18px | 500 | 1.5 | 2px |
| Body | Open Sans, Arial, sans-serif | 16px | 300 | 1.333333 | 5px |
| Caption | sans-serif | 13px | 600 | 30px | 5px |
| Button | monospace, monospace | 21px | 200 | 46px | 5px |
| Mono | monospace, monospace | 16px | 200 | 46px | 5px |
| Label | monospace, monospace | 16px | 200 | 46px | 5px |
...
### Quick Prompt
> "Based on the `meme 15 spotlight` design system, use the color palette and typography hierarchy above to generate a modern landing page with navigation, hero section, card grid, and form — output both light and dark themes."
