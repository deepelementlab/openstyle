# Design System: dgfp 5 Vesperr

## 1. Visual Theme & Atmosphere

This template presents a structured, modular web design built on a mid gray with white canvas, using Blue as the primary accent for interactive elements. The typography is anchored by `Raleway`, creating a consistent reading experience. The type scale spans 14px to 24px across 8 levels.
...
|------|------|------|--------|-------------|----------------|
| Display | Raleway, sans-serif | 14px | 400 | 1.5 | 1px |
| Heading | IcoFont | 14px | 700 | 1 | normal |
| Sub-heading | -apple-system, BlinkMacSystemFont, Segoe UI, Roboto, Helvetica Neue, Arial, Noto Sans, sans-serif, Apple Color Emoji, Segoe UI Emoji, Segoe UI Symbol, Noto Color Emoji | 20px | 600 | inherit | normal |
| Body | Open Sans, sans-serif | 16px | 300 | 1.2 | normal |
| Caption | SFMono-Regular, Menlo, Monaco, Consolas, Liberation Mono, Courier New, monospace | 18px | 500 | 28px | normal |
| Button | Poppins, sans-serif | 16px | bolder | 0 | normal |
| Mono | Poppins, sans-serif | 24px | bolder | 0 | normal |
| Label | Poppins, sans-serif | 15px | bolder | 0 | normal |
...
- Use `#3498db` as the primary accent for CTAs and interactive elements.
...
### Quick Prompt
> "Based on the `dgfp 5 Vesperr` design system, use the color palette and typography hierarchy above to generate a modern landing page with navigation, hero section, card grid, and form — output both light and dark themes."

### Key Token Reference
- **Text:** White (`#fff`)
- **CTA / Accent:** Blue (`#3498db`)
- **Border:** White 2 (`#fff`)
