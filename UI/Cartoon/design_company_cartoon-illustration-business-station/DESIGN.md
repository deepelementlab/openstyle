...
- **Soft Blue** (`#705ecf`): CTAs, links, and interactive highlights
### Neutral
...
| Heading | inherit | 20px | 600 | 1 | 2px |
| Sub-heading | sans-serif | 14px | 700 | inherit | normal |
| Body | monospace, monospace | 16px | 300 | 1.2 | 0.5px |
| Caption | SFMono-Regular, Menlo, Monaco, Consolas, Liberation Mono, Courier New, monospace | 16px | 500 | 0 | 0.5px |
| Button | Poppins, sans-serif | 16px | bolder | 1.15 | 0.5px |
| Mono | Poppins, sans-serif | 16px | bolder | 1.15 | 0.5px |
| Label | Poppins, sans-serif | 14px | bolder | 1.15 | 0.5px |
...
### Quick Prompt
> "Based on the `cpts 1970 dfa` design system, use the color palette and typography hierarchy above to generate a modern landing page with navigation, hero section, card grid, and form — output both light and dark themes."
