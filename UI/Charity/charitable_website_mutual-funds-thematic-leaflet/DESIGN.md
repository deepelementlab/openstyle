...
- **Vivid Amber** (`#ECC731`): CTAs, links, and interactive highlights
...
| Heading | inherit | 18px | 700 | 1 | -5px |
| Sub-heading | sans-serif | 14px | 300 | 1.5 | -5px |
| Body | monospace, monospace | 16px | 500 | 30px | -5px |
| Caption | Glyphicons Halflings | 16px | bold | 1.333333 | -5px |
| Button | Menlo, Monaco, Consolas, Courier New, monospace | 16px | 200 | 46px | -5px |
| Mono | Menlo, Monaco, Consolas, Courier New, monospace | 16px | 200 | 46px | -5px |
| Label | Menlo, Monaco, Consolas, Courier New, monospace | 16px | 200 | 46px | -5px |
...
### Quick Prompt
> "Based on the `cpts 1572 cms` design system, use the color palette and typography hierarchy above to generate a modern landing page with navigation, hero section, card grid, and form — output both light and dark themes."
