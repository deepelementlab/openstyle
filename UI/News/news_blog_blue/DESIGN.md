# Design System: cpts 2013 czu

## 1. Visual Theme & Atmosphere

This template presents a structured, modular web design built on a black with pale green canvas, using Blue as the primary accent for interactive elements. The typography is anchored by `Libre Baskerville`, creating a consistent reading experience. The type scale spans 12px to 18px across 7 levels.
...
- **Soft Vivid Amber** (`#F8DA56`): CTAs, links, and interactive highlights
...
### Font Families
- `"Libre Baskerville", serif` (Primary)
- `inherit`
- `sans-serif`
- `monospace, monospace`
...
|------|------|------|--------|-------------|----------------|
| Display | Libre Baskerville, serif | 14px | 400 | 1.428571 | 1px |
| Heading | inherit | 16px | 300 | 1.8em | 1px |
| Sub-heading | sans-serif | 12px | 700 | 1 | 1px |
| Body | monospace, monospace | 18px | bold | 0 | 1px |
| Caption | Helvetica Neue, Helvetica, Arial, sans-serif | 16px | 200 | 1.5 | 1px |
| Button | Menlo, Monaco, Consolas, Courier New, monospace | 16px | 600 | 1.33 | 1px |
| Mono | Menlo, Monaco, Consolas, Courier New, monospace | 16px | 600 | 1.33 | 1px |
| Label | Menlo, Monaco, Consolas, Courier New, monospace | 0.0 | 600 | 1.33 | 1px |
...
- Use `Libre Baskerville` as the base font family to preserve the template's typographic identity.
...
### Quick Prompt
> "Based on the `cpts 2013 czu` design system, use the color palette and typography hierarchy above to generate a modern landing page with navigation, hero section, card grid, and form — output both light and dark themes."
