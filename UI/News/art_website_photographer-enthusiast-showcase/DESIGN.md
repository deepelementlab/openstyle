# Design System: cpts 872 bhw

## 1. Visual Theme & Atmosphere

This template presents a structured, modular web design built on a mid gray with pale vivid yellow canvas, using Blue as the primary accent for interactive elements. The typography is anchored by `Helvetica Neue`, creating a consistent reading experience. The type scale spans 12px to 18px across 8 levels.
...
- **Blue 2** (`#38708F`): CTAs, links, and interactive highlights
...
- **Soft Vivid Red** (`#f65a5b`): CTAs, links, and interactive highlights
### Neutral
...
|------|------|------|--------|-------------|----------------|
| Display | Helvetica Neue, Helvetica, Arial, sans-serif | 14px | normal | 1.428571 | normal |
| Heading | Syncopate, sans-serif | 12px | 300 | 1.8em | normal |
| Sub-heading | inherit | 18px | bold | 1 | normal |
| Body | Open Sans, sans-serif | 16px | 200 | 1.5 | normal |
| Caption | sans-serif | 13px | 500 | 1.333333 | normal |
| Button | monospace, monospace | 16px | 600 | 30px | normal |
| Mono | monospace, monospace | 16px | 600 | 30px | normal |
| Label | monospace, monospace | 16px | 600 | 30px | normal |
...
### Quick Prompt
> "Based on the `cpts 872 bhw` design system, use the color palette and typography hierarchy above to generate a modern landing page with navigation, hero section, card grid, and form — output both light and dark themes."
