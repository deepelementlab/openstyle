...
- **Soft Vivid Amber** (`#efb14f`): CTAs, links, and interactive highlights
...
|------|------|------|--------|-------------|----------------|
| Display | Helvetica Neue, Helvetica, Arial, sans-serif | 14px | 300 | 1.428571 | 1px |
| Heading | inherit | 12px | bold | 1 | 2px |
| Sub-heading | Lato, sans-serif | 18px | normal | 1.5 | 3px |
| Body | sans-serif | 16px | 600 | 2em | 3px |
| Caption | monospace, monospace | 15px | 400 | 30px | 3px |
| Button | Glyphicons Halflings | 24px | 500 | 1.333333 | 3px |
| Mono | Glyphicons Halflings | 16px | 500 | 1.333333 | 3px |
| Label | Glyphicons Halflings | 16px | 500 | 1.333333 | 3px |
...
### Quick Prompt
> "Based on the `cpts 1722 coo` design system, use the color palette and typography hierarchy above to generate a modern landing page with navigation, hero section, card grid, and form — output both light and dark themes."
