...
| Sub-heading | flexslider-icon | 18px | bold | 1.5 | 2px |
| Body | Open Sans, Arial, sans-serif | 16px | 600 | 1.333333 | 1px |
| Caption | sans-serif | 13px | 500 | 30px | 5px |
| Button | monospace, monospace | 21px | 300 | 46px | 5px |
| Mono | monospace, monospace | 16px | 300 | 46px | 5px |
| Label | monospace, monospace | 30px | 300 | 46px | 5px |
...
### Quick Prompt
> "Based on the `wait 30 reload` design system, use the color palette and typography hierarchy above to generate a modern landing page with navigation, hero section, card grid, and form — output both light and dark themes."
