# Design System: cpts 1653 cma

## 1. Visual Theme & Atmosphere

This template presents a structured, modular web design built on a black with pale vivid yellow canvas, using Vivid Pink as the primary accent for interactive elements. The typography is anchored by `Helvetica Neue`, creating a consistent reading experience. The type scale spans 12px to 20px across 8 levels.
...
### Accent
- **Vivid Pink** (`#e709c1`): CTAs, links, and interactive highlights
...
|------|------|------|--------|-------------|----------------|
| Display | Helvetica Neue, Helvetica, Arial, sans-serif | 14px | normal | 1.428571 | 2px |
| Heading | inherit | 12px | bold | 1 | 1px |
| Sub-heading | Montserrat, sans-serif | 16px | 600 | 1.5 | 3px |
| Body | sans-serif | 18px | 400 | 1.8em | 0.5px |
| Caption | monospace, monospace | 16px | 500 | 30px | 13px |
| Button | Glyphicons Halflings | 20px | 300 | 1.333333 | 4px |
| Mono | Glyphicons Halflings | 16px | 300 | 1.333333 | 4px |
| Label | Glyphicons Halflings | 16px | 300 | 1.333333 | 4px |
...
- Use `#e709c1` as the primary accent for CTAs and interactive elements.
...
### Quick Prompt
> "Based on the `cpts 1653 cma` design system, use the color palette and typography hierarchy above to generate a modern landing page with navigation, hero section, card grid, and form — output both light and dark themes."

### Key Token Reference
- **Text:** Pale Vivid Yellow (`#fcf8e3`)
- **CTA / Accent:** Vivid Pink (`#e709c1`)
- **Border:** White (`#fff`)
