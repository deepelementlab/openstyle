# Design System: cpts 774 big

## 1. Visual Theme & Atmosphere

This template presents a structured, modular web design built on a charcoal with pale vivid yellow canvas, using Blue as the primary accent for interactive elements. The typography is anchored by `Lato`, creating a consistent reading experience. The type scale spans 12px to 20px across 8 levels.
...
- **Vivid Blue** (`#0080ff`): CTAs, links, and interactive highlights
...
|------|------|------|--------|-------------|----------------|
| Display | Lato, sans-serif | 14px | 600 | 1.428571 | 10px |
| Heading | Helvetica Neue, Helvetica, Arial, sans-serif | 16px | bold | 1 | 5px |
| Sub-heading | inherit | 12px | normal | 1.5 | 2px |
| Body | Playfair Display, serif | 18px | 900 | 1.333333 | 2px |
| Caption | Verdana, Arial, sans-serif | 13px | 500 | 30px | 2px |
| Button | sans-serif | 20px | 700 | 46px | 2px |
| Mono | sans-serif | 15px | 700 | 46px | 2px |
| Label | sans-serif | 16px | 700 | 46px | 2px |
...
### Quick Prompt
> "Based on the `cpts 774 big` design system, use the color palette and typography hierarchy above to generate a modern landing page with navigation, hero section, card grid, and form — output both light and dark themes."
